# ExtendedReadSessionRecordWithChildrenRedactedOutput2
...
### `models.ExtendedReadSessionRecordWithChildrenRedactedOutput1[]`

```typescript
const value: models.ExtendedReadSessionRecordWithChildrenRedactedOutput1[] = [
  {
    type: "text",
    text: "<value>",
  },
