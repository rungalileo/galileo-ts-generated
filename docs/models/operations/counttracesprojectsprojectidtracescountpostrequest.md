...
```typescript
import { CountTracesProjectsProjectIdTracesCountPostRequest } from "galileo-generated/models/operations";

let value: CountTracesProjectsProjectIdTracesCountPostRequest = {
  projectId: "<value>",
  body: {
