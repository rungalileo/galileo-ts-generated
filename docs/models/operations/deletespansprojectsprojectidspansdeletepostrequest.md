...
```typescript
import { DeleteSpansProjectsProjectIdSpansDeletePostRequest } from "galileo-generated/models/operations";

let value: DeleteSpansProjectsProjectIdSpansDeletePostRequest = {
  projectId: "<value>",
  body: {
