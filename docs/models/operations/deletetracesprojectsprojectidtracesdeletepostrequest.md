...
```typescript
import { DeleteTracesProjectsProjectIdTracesDeletePostRequest } from "galileo-generated/models/operations";

let value: DeleteTracesProjectsProjectIdTracesDeletePostRequest = {
  projectId: "<value>",
  body: {
