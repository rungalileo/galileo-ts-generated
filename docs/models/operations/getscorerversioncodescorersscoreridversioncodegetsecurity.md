...
```typescript
import { GetScorerVersionCodeScorersScorerIdVersionCodeGetSecurity } from "galileo-generated/models/operations";

let value: GetScorerVersionCodeScorersScorerIdVersionCodeGetSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
