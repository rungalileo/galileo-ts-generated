...
```typescript
import { ExtendDatasetContentDatasetsExtendPostSecurity } from "galileo-generated/models/operations";

let value: ExtendDatasetContentDatasetsExtendPostSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
