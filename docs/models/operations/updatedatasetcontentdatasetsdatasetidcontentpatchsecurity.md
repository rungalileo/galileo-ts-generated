...
```typescript
import { UpdateDatasetContentDatasetsDatasetIdContentPatchSecurity } from "galileo-generated/models/operations";

let value: UpdateDatasetContentDatasetsDatasetIdContentPatchSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
