...
```typescript
import { SelectIntegrationIntegrationsSelectPostSecurity } from "galileo-generated/models/operations";

let value: SelectIntegrationIntegrationsSelectPostSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
