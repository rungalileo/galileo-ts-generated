...
```typescript
import { ExportBillingUsageBillingUsageExportGetSecurity } from "galileo-generated/models/operations";

let value: ExportBillingUsageBillingUsageExportGetSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
