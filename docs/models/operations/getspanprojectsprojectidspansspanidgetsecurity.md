...
```typescript
import { GetSpanProjectsProjectIdSpansSpanIdGetSecurity } from "galileo-generated/models/operations";

let value: GetSpanProjectsProjectIdSpansSpanIdGetSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
