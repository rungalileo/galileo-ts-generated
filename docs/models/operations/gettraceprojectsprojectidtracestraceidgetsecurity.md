...
```typescript
import { GetTraceProjectsProjectIdTracesTraceIdGetSecurity } from "galileo-generated/models/operations";

let value: GetTraceProjectsProjectIdTracesTraceIdGetSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
