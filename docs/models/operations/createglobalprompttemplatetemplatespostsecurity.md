...
```typescript
import { CreateGlobalPromptTemplateTemplatesPostSecurity } from "galileo-generated/models/operations";

let value: CreateGlobalPromptTemplateTemplatesPostSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
