...
```typescript
import { QueryDatasetContentDatasetsDatasetIdContentQueryPostSecurity } from "galileo-generated/models/operations";

let value: QueryDatasetContentDatasetsDatasetIdContentQueryPostSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
