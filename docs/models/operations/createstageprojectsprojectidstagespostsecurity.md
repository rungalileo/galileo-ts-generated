...
```typescript
import { CreateStageProjectsProjectIdStagesPostSecurity } from "galileo-generated/models/operations";

let value: CreateStageProjectsProjectIdStagesPostSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
