...
```typescript
import { CountSessionsProjectsProjectIdSessionsCountPostRequest } from "galileo-generated/models/operations";

let value: CountSessionsProjectsProjectIdSessionsCountPostRequest = {
  projectId: "<value>",
  body: {
