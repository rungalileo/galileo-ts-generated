...
```typescript
import { CreateOrUpdateIntegrationIntegrationsAnthropicPutSecurity } from "galileo-generated/models/operations";

let value: CreateOrUpdateIntegrationIntegrationsAnthropicPutSecurity = {
  httpBasic: {
    username: "",
    password: "",
  },
