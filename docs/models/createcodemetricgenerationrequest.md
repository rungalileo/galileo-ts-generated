...
| `outputType`                                                                                   | [models.OutputTypeEnum](../models/outputtypeenum.md)                                           | :heavy_minus_sign:                                                                             | Selected output type (boolean, percentage, count, discrete, categorical, multilabel, freeform) |
