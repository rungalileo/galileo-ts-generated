...
let value: StubTraceRecord = {
  type: "stub_trace",
  id: "<value>",
  createdAt: new Date("2026-07-07T14:12:23.894Z"),
};
```
...
| `createdAt`                                                                                   | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) | :heavy_check_mark:                                                                            | Earliest created_at among child spans; used to order under a session.                         |