...
* [exportToDatabricksIntegrationsDatabricksExportPost](#exporttodatabricksintegrationsdatabricksexportpost) - Export To Databricks
...
* [exportToDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogExportPost](#exporttodatabricksunitycatalogintegrationsdatabricksunitycatalogexportpost) - Export To Databricks Unity Catalog
...
* [createOrUpdateIntegrationIntegrationsLabelstudioPut](#createorupdateintegrationintegrationslabelstudioput) - Create Or Update Integration
* [getLabelstudioProjectsIntegrationsLabelstudioProjectsGet](#getlabelstudioprojectsintegrationslabelstudioprojectsget) - Get Labelstudio Projects
* [exportToLabelstudioIntegrationsLabelstudioExportPost](#exporttolabelstudiointegrationslabelstudioexportpost) - Export To Labelstudio
...
## exportToDatabricksIntegrationsDatabricksExportPost

Export To Databricks

### Example Usage

<!-- UsageSnippet language="typescript" operationID="export_to_databricks_integrations_databricks_export_post" method="post" path="/integrations/databricks/export" -->
```typescript
import { GalileoGenerated } from "galileo-generated";
...
async function run() {
  const result = await galileoGenerated.integrations.exportToDatabricksIntegrationsDatabricksExportPost({
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    databaseName: "<value>",
    tableName: "<value>",
...
```typescript
import { GalileoGeneratedCore } from "galileo-generated/core.js";
import { integrationsExportToDatabricksIntegrationsDatabricksExportPost } from "galileo-generated/funcs/integrationsExportToDatabricksIntegrationsDatabricksExportPost.js";
...
async function run() {
  const res = await integrationsExportToDatabricksIntegrationsDatabricksExportPost(galileoGenerated, {
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    databaseName: "<value>",
    tableName: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("integrationsExportToDatabricksIntegrationsDatabricksExportPost failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.DatabricksExportRequest](../../models/databricksexportrequest.md)                                                                                                      | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `security`                                                                                                                                                                     | [operations.ExportToDatabricksIntegrationsDatabricksExportPostSecurity](../../models/operations/exporttodatabricksintegrationsdatabricksexportpostsecurity.md)                 | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.DatabricksExportResponse](../../models/databricksexportresponse.md)\>**
...
async function run() {
  const result = await galileoGenerated.integrations.exportEditsDatabricksIntegrationsDatabricksEditsExportPost({
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    body: {
      editIds: [
...
## exportToDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogExportPost

Export To Databricks Unity Catalog

### Example Usage

<!-- UsageSnippet language="typescript" operationID="export_to_databricks_unity_catalog_integrations_databricks_unity_catalog_export_post" method="post" path="/integrations/databricks/unity-catalog/export" -->
```typescript
import { GalileoGenerated } from "galileo-generated";
...
async function run() {
  const result = await galileoGenerated.integrations.exportToDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogExportPost({
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    databaseName: "<value>",
    tableName: "<value>",
...
import { GalileoGeneratedCore } from "galileo-generated/core.js";
import {
  integrationsExportToDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogExportPost,
} from "galileo-generated/funcs/integrationsExportToDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogExportPost.js";
...
async function run() {
  const res = await integrationsExportToDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogExportPost(galileoGenerated, {
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    databaseName: "<value>",
    tableName: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("integrationsExportToDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogExportPost failed:", res.error);
  }
}
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                                                                                                                      | [models.DatabricksExportRequest](../../models/databricksexportrequest.md)                                                                                                                                      | :heavy_check_mark:                                                                                                                                                                                             | The request object to use for the request.                                                                                                                                                                     |
| `security`                                                                                                                                                                                                     | [operations.ExportToDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogExportPostSecurity](../../models/operations/exporttodatabricksunitycatalogintegrationsdatabricksunitycatalogexportpostsecurity.md) | :heavy_check_mark:                                                                                                                                                                                             | The security requirements to use for the request.                                                                                                                                                              |
| `options`                                                                                                                                                                                                      | RequestOptions                                                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                                                        | :heavy_minus_sign:                                                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed.                                 |
| `options.retries`                                                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                                                               |
...
**Promise\<[models.DatabricksUnityCatalogExportResponse](../../models/databricksunitycatalogexportresponse.md)\>**
...
async function run() {
  const result = await galileoGenerated.integrations.exportEditsDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogEditsExportPost({
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    body: {
      editIds: [
...
## createOrUpdateIntegrationIntegrationsLabelstudioPut

Create or update a labelstudio integration for this user from Galileo.

### Example Usage

<!-- UsageSnippet language="typescript" operationID="create_or_update_integration_integrations_labelstudio_put" method="put" path="/integrations/labelstudio" -->
```typescript
import { GalileoGenerated } from "galileo-generated";
...
async function run() {
  const result = await galileoGenerated.integrations.createOrUpdateIntegrationIntegrationsLabelstudioPut({
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    token: "<value>",
    url: "https://impure-sideboard.biz",
    isEnterprise: true,
  });
...
```typescript
import { GalileoGeneratedCore } from "galileo-generated/core.js";
import { integrationsCreateOrUpdateIntegrationIntegrationsLabelstudioPut } from "galileo-generated/funcs/integrationsCreateOrUpdateIntegrationIntegrationsLabelstudioPut.js";
...
async function run() {
  const res = await integrationsCreateOrUpdateIntegrationIntegrationsLabelstudioPut(galileoGenerated, {
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    token: "<value>",
    url: "https://impure-sideboard.biz",
  ...
  if (res.ok) {
    ...
    console.log("integrationsCreateOrUpdateIntegrationIntegrationsLabelstudioPut failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.LabelStudioIntegrationCreate](../../models/labelstudiointegrationcreate.md)                                                                                            | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `security`                                                                                                                                                                     | [operations.CreateOrUpdateIntegrationIntegrationsLabelstudioPutSecurity](../../models/operations/createorupdateintegrationintegrationslabelstudioputsecurity.md)               | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
## getLabelstudioProjectsIntegrationsLabelstudioProjectsGet

Get Labelstudio Projects

### Example Usage

<!-- UsageSnippet language="typescript" operationID="get_labelstudio_projects_integrations_labelstudio_projects_get" method="get" path="/integrations/labelstudio/projects" -->
```typescript
import { GalileoGenerated } from "galileo-generated";
...
async function run() {
  const result = await galileoGenerated.integrations.getLabelstudioProjectsIntegrationsLabelstudioProjectsGet({
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  });
...
```typescript
import { GalileoGeneratedCore } from "galileo-generated/core.js";
import { integrationsGetLabelstudioProjectsIntegrationsLabelstudioProjectsGet } from "galileo-generated/funcs/integrationsGetLabelstudioProjectsIntegrationsLabelstudioProjectsGet.js";
...
async function run() {
  const res = await integrationsGetLabelstudioProjectsIntegrationsLabelstudioProjectsGet(galileoGenerated, {
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("integrationsGetLabelstudioProjectsIntegrationsLabelstudioProjectsGet failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `security`                                                                                                                                                                     | [operations.GetLabelstudioProjectsIntegrationsLabelstudioProjectsGetSecurity](../../models/operations/getlabelstudioprojectsintegrationslabelstudioprojectsgetsecurity.md)     | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.LabelStudioProject[]](../../models/.md)\>**
...
## exportToLabelstudioIntegrationsLabelstudioExportPost

Export To Labelstudio

### Example Usage

<!-- UsageSnippet language="typescript" operationID="export_to_labelstudio_integrations_labelstudio_export_post" method="post" path="/integrations/labelstudio/export" -->
```typescript
import { GalileoGenerated } from "galileo-generated";
...
async function run() {
  const result = await galileoGenerated.integrations.exportToLabelstudioIntegrationsLabelstudioExportPost({
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    projectName: "<value>",
    projectId: "<value>",
...
```typescript
import { GalileoGeneratedCore } from "galileo-generated/core.js";
import { integrationsExportToLabelstudioIntegrationsLabelstudioExportPost } from "galileo-generated/funcs/integrationsExportToLabelstudioIntegrationsLabelstudioExportPost.js";
...
async function run() {
  const res = await integrationsExportToLabelstudioIntegrationsLabelstudioExportPost(galileoGenerated, {
    apiKeyHeader: process.env["GALILEOGENERATED_API_KEY_HEADER"] ?? "",
  }, {
    projectName: "<value>",
    projectId: "<value>",
  ...
  if (res.ok) {
    ...
    console.log("integrationsExportToLabelstudioIntegrationsLabelstudioExportPost failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.LabelStudioExportRequest](../../models/labelstudioexportrequest.md)                                                                                                    | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `security`                                                                                                                                                                     | [operations.ExportToLabelstudioIntegrationsLabelstudioExportPostSecurity](../../models/operations/exporttolabelstudiointegrationslabelstudioexportpostsecurity.md)             | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
