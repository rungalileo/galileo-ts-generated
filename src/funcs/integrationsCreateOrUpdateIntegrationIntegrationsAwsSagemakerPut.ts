 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsAwsSagemakerPut(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.AwsSageMakerIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/aws_sagemaker")();
