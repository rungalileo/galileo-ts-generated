 ...
 */
export function logStreamUpdateLogStreamProjectsProjectIdLogStreamsLogStreamIdPut(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/log_streams/{log_stream_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogStreamResponse$inboundSchema),
