 ...
 */
export function integrationsCreateOrUpdateUnityCatalogIntegrationIntegrationsDatabricksPut(
...
> {
  ...
  const path = pathToFunc("/integrations/databricks")();
