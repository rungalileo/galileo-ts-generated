 ...
 */
export function annotationQueueListAnnotationQueueUsersAnnotationQueuesQueueIdUsersGet(
  ...
  Result<
    models.ListAnnotationQueueCollaboratorsResponse,
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/users")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListAnnotationQueueCollaboratorsResponse$inboundSchema),
