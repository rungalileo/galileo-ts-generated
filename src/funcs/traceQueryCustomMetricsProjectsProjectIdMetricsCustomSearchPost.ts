 ...
 */
export function traceQueryCustomMetricsProjectsProjectIdMetricsCustomSearchPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/metrics/custom_search")(
    pathParams,
  );
