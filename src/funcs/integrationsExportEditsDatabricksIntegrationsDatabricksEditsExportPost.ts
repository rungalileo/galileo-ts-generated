 ...
 */
export function integrationsExportEditsDatabricksIntegrationsDatabricksEditsExportPost(
  ...
  Result<
    models.DatabricksEditExportResponse,
...
> {
  ...
  const path = pathToFunc("/integrations/databricks/edits/export")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DatabricksEditExportResponse$inboundSchema),
