 ...
 */
export function annotationQueueShareAnnotationQueueWithUsersAnnotationQueuesQueueIdUsersPost(
  ...
  Result<
    Array<models.UserAnnotationQueueCollaborator>,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.UserAnnotationQueueCollaborator$inboundSchema)),
