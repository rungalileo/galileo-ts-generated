 ...
 */
export function projectsGetProjectsPaginatedProjectsPaginatedPost(
  ...
  Result<
    models.ApiSchemasProjectGetProjectsPaginatedResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .GetProjectsPaginatedProjectsPaginatedPostRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/projects/paginated")();
  ...
  >(
    M.json(
      200,
      models.ApiSchemasProjectGetProjectsPaginatedResponse$inboundSchema,
    ),
