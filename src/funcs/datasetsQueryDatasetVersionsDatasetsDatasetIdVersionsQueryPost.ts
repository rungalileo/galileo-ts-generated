 ...
 */
export function datasetsQueryDatasetVersionsDatasetsDatasetIdVersionsQueryPost(
  ...
  Result<
    models.ListDatasetVersionResponse,
...
> {
  ...
  const path = pathToFunc("/datasets/{dataset_id}/versions/query")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListDatasetVersionResponse$inboundSchema),
