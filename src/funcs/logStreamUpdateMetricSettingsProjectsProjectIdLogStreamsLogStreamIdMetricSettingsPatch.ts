 ...
 */
export function logStreamUpdateMetricSettingsProjectsProjectIdLogStreamsLogStreamIdMetricSettingsPatch(
...
> {
  ...
  const pathParams = {
    log_stream_id: encodeSimple("log_stream_id", payload.log_stream_id, {
      explode: false,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.MetricSettingsResponse$inboundSchema),
