 ...
 */
export function traceQueryPartialTracesProjectsProjectIdTracesPartialSearchPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/traces/partial_search")(
    pathParams,
  );
