 ...
 * Get Trace
 */
export function traceGetTraceProjectsProjectIdTracesTraceIdGet(
  ...
  Result<
    operations.ResponseGetTraceProjectsProjectIdTracesTraceIdGet,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetTraceProjectsProjectIdTracesTraceIdGetRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations
        .ResponseGetTraceProjectsProjectIdTracesTraceIdGet$inboundSchema,
    ),
