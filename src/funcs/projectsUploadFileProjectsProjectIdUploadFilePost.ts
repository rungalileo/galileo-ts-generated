 ...
 * Upload File
 */
export function projectsUploadFileProjectsProjectIdUploadFilePost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .UploadFileProjectsProjectIdUploadFilePostRequest$outboundSchema,
        value,
      ),
  ...
  appendForm(body, "upload_metadata", payload.body.upload_metadata);
  ...
  const path = pathToFunc("/projects/{project_id}/upload_file")(pathParams);
