 ...
 */
export function annotationQueueReorderQueueTemplatesAnnotationQueuesQueueIdTemplatesReorderPost(
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/templates/reorder")(
    pathParams,
  );
