 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsLabelstudioPut(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.LabelStudioIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/labelstudio")();
