 ...
 */
export function annotationQueueRecordsExportAnnotationQueueRecordsAnnotationQueuesQueueIdRecordsExportPost(
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/records/export")(
    pathParams,
  );
