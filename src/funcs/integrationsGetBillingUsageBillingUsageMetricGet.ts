 ...
 * Get Billing Usage
 */
export function integrationsGetBillingUsageBillingUsageMetricGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetBillingUsageBillingUsageMetricGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/billing/usage/{metric}")(pathParams);
  ...
  const context = {
    ...
    operationID: "get_billing_usage_billing_usage__metric__get",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BillingUsageResponse$inboundSchema),
