 ...
 */
export function integrationsGetNamedCustomIntegrationStatusIntegrationsCustomNameStatusGet(
...
> {
  ...
  const path = pathToFunc("/integrations/custom/{name}/status")(pathParams);
