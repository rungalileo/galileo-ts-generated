 ...
 */
export function annotationQueueUpdateQueueTemplateAnnotationQueuesQueueIdTemplatesTemplateIdPatch(
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AnnotationTemplateDB$inboundSchema),
