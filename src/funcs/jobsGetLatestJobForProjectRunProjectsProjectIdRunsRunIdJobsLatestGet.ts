 ...
 */
export function jobsGetLatestJobForProjectRunProjectsProjectIdRunsRunIdJobsLatestGet(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/runs/{run_id}/jobs/latest")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.JobDB$inboundSchema),
