 ...
 */
export function llmIntegrationsGetRecommendedModelsLlmIntegrationsRecommendedModelsGet(
  ...
  Result<
    models.RecommendedModelsResponse,
...
> {
  const path = pathToFunc("/llm_integrations/recommended_models")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RecommendedModelsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
