 ...
 * Update Dataset
 */
export function datasetsUpdateDatasetDatasetsDatasetIdPatch(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateDatasetDatasetsDatasetIdPatchRequest$outboundSchema,
        value,
      ),
