 ...
 * Create
 */
export function promptsCreateScorersPost(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateScorerRequest$outboundSchema, value),
