 ...
 */
export function experimentCreateExperimentProjectsProjectIdExperimentsPost(
  client: GalileoGeneratedCore,
  security: operations.CreateExperimentProjectsProjectIdExperimentsPostSecurity,
