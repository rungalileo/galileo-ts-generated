 ...
 * Delete Scorer
 */
export function promptsDeleteScorerScorersScorerIdDelete(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteScorerScorersScorerIdDeleteRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteScorerResponse$inboundSchema),
