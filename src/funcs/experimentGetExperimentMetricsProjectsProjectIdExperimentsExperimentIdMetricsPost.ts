 ...
 */
export function experimentGetExperimentMetricsProjectsProjectIdExperimentsExperimentIdMetricsPost(
  ...
  Result<
    models.ExperimentMetricsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ExperimentMetricsResponse$inboundSchema),
