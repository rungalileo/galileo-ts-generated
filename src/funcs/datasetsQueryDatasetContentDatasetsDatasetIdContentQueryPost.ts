 ...
 */
export function datasetsQueryDatasetContentDatasetsDatasetIdContentQueryPost(
...
> {
  ...
  const path = pathToFunc("/datasets/{dataset_id}/content/query")(pathParams);
