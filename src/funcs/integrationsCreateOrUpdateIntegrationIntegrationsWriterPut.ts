 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsWriterPut(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.WriterIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/writer")();
