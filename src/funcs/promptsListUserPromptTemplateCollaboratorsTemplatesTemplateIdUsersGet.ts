 ...
 */
export function promptsListUserPromptTemplateCollaboratorsTemplatesTemplateIdUsersGet(
...
> {
  ...
  const path = pathToFunc("/templates/{template_id}/users")(pathParams);
