 ...
 */
export function logStreamListLogStreamsPaginatedProjectsProjectIdLogStreamsPaginatedGet(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/log_streams/paginated")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListLogStreamResponse$inboundSchema),
