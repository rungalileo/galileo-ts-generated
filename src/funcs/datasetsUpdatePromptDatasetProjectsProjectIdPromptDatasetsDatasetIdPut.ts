 ...
 */
export function datasetsUpdatePromptDatasetProjectsProjectIdPromptDatasetsDatasetIdPut(
...
> {
  ...
  if (payload.body != null) {
    if (payload.body.column_names !== undefined) {
      appendForm(body, "column_names", payload.body.column_names);
    }
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PromptDatasetDB$inboundSchema),
