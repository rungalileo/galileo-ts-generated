 ...
 */
export function promptsQueryTemplatesTemplatesQueryPost(
  ...
  Result<
    models.ListPromptTemplateResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.QueryTemplatesTemplatesQueryPostRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/templates/query")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListPromptTemplateResponse$inboundSchema),
