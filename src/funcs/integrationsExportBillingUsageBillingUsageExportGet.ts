 ...
 */
export function integrationsExportBillingUsageBillingUsageExportGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .ExportBillingUsageBillingUsageExportGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/billing/usage/export")();
  ...
  const context = {
    ...
    operationID: "export_billing_usage_billing_usage_export_get",
    oAuth2Scopes: [],
