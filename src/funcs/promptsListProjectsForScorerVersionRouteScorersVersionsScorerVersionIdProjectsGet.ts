 ...
 */
export function promptsListProjectsForScorerVersionRouteScorersVersionsScorerVersionIdProjectsGet(
  ...
  Result<
    models.ApiSchemasProjectV2GetProjectsPaginatedResponse,
...
> {
  ...
  const pathParams = {
    scorer_version_id: encodeSimple(
      "scorer_version_id",
      payload.scorer_version_id,
  ...
  const query = encodeFormQuery({
    ...
    "starting_token": payload.starting_token,
  });
  ...
  >(
    M.json(
      200,
      models.ApiSchemasProjectV2GetProjectsPaginatedResponse$inboundSchema,
    ),
