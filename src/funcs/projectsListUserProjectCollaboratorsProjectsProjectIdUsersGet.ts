 ...
 */
export function projectsListUserProjectCollaboratorsProjectsProjectIdUsersGet(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/users")(pathParams);
