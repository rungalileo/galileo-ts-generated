 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsOpenaiPut(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.OpenAIIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/openai")();
