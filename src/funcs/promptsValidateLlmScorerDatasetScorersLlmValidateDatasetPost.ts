 ...
 */
export function promptsValidateLlmScorerDatasetScorersLlmValidateDatasetPost(
  ...
  Result<
    models.ValidateLLMScorerDatasetResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.ValidateLLMScorerDatasetRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/scorers/llm/validate/dataset")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ValidateLLMScorerDatasetResponse$inboundSchema),
