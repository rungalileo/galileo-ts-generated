 ...
 */
export function promptsDeleteGlobalTemplateTemplatesTemplateIdDelete(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .DeleteGlobalTemplateTemplatesTemplateIdDeleteRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "delete_global_template_templates__template_id__delete",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeletePromptResponse$inboundSchema),
