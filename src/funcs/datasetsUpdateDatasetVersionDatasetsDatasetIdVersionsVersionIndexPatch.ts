 ...
 */
export function datasetsUpdateDatasetVersionDatasetsDatasetIdVersionsVersionIndexPatch(
...
> {
  ...
  const path = pathToFunc("/datasets/{dataset_id}/versions/{version_index}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DatasetVersionDB$inboundSchema),
