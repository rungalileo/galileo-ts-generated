 ...
 */
export function annotationQueueCreateAnnotationQueueAnnotationQueuesPost(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.CreateAnnotationQueueRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/annotation_queues")();
