 ...
 */
export function traceSpansAvailableColumnsProjectsProjectIdSpansAvailableColumnsPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/spans/available_columns")(
    pathParams,
  );
