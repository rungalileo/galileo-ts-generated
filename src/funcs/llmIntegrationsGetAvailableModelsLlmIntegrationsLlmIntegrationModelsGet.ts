 ...
 */
export function llmIntegrationsGetAvailableModelsLlmIntegrationsLlmIntegrationModelsGet(
...
> {
  ...
  const pathParams = {
    llm_integration: encodeSimple("llm_integration", payload.llm_integration, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/llm_integrations/{llm_integration}/models")(
    pathParams,
  );
