 ...
 * Get Dataset Content
 */
export function datasetsGetDatasetContentDatasetsDatasetIdContentGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetDatasetContentDatasetsDatasetIdContentGetRequest$outboundSchema,
        value,
      ),
