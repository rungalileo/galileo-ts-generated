 ...
 * Export Records
 */
export function traceExportRecordsProjectsProjectIdExportRecordsPost(
  client: GalileoGeneratedCore,
  security: operations.ExportRecordsProjectsProjectIdExportRecordsPostSecurity,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .ExportRecordsProjectsProjectIdExportRecordsPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/export_records")(pathParams);
  ...
  const context = {
    ...
    operationID: "export_records_projects__project_id__export_records_post",
    oAuth2Scopes: [],
