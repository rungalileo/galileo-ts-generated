 ...
 */
export function annotationQueueRecordsRemoveRecordsFromAnnotationQueueAnnotationQueuesQueueIdRecordsRemovePost(
  ...
  Result<
    models.RemoveRecordsFromQueueResponse,
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/records/remove")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RemoveRecordsFromQueueResponse$inboundSchema),
