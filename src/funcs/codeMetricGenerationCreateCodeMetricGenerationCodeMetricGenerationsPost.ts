 ...
 */
export function codeMetricGenerationCreateCodeMetricGenerationCodeMetricGenerationsPost(
  ...
  Result<
    models.CreateCodeMetricGenerationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.CreateCodeMetricGenerationRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/code-metric-generations")();
  ...
  const context = {
    ...
    operationID: "create_code_metric_generation_code_metric_generations_post",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, models.CreateCodeMetricGenerationResponse$inboundSchema),
