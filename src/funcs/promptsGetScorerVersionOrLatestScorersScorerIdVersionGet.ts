 ...
 */
export function promptsGetScorerVersionOrLatestScorersScorerIdVersionGet(
  client: GalileoGeneratedCore,
  security:
    operations.GetScorerVersionOrLatestScorersScorerIdVersionGetSecurity,
  request: operations.GetScorerVersionOrLatestScorersScorerIdVersionGetRequest,
...
> {
  ...
  const path = pathToFunc("/scorers/{scorer_id}/version")(pathParams);
