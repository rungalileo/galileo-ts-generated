 ...
 */
export function traceQueryPartialSessionsProjectsProjectIdSessionsPartialSearchPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/sessions/partial_search")(
    pathParams,
  );
