 ...
 * Preview Dataset
 */
export function datasetsPreviewDatasetDatasetsDatasetIdPreviewPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .PreviewDatasetDatasetsDatasetIdPreviewPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/datasets/{dataset_id}/preview")(pathParams);
