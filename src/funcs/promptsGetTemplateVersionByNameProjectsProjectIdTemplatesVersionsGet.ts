 ...
 */
export function promptsGetTemplateVersionByNameProjectsProjectIdTemplatesVersionsGet(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/templates/versions")(
    pathParams,
  );
