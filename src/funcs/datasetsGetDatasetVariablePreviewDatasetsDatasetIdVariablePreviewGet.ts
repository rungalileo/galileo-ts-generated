 ...
 */
export function datasetsGetDatasetVariablePreviewDatasetsDatasetIdVariablePreviewGet(
  ...
  Result<
    Array<models.DatasetInputJsonField>,
...
> {
  ...
  const path = pathToFunc("/datasets/{dataset_id}/variable_preview")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.DatasetInputJsonField$inboundSchema)),
