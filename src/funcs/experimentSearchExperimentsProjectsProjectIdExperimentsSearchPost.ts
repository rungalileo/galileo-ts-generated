 ...
 */
export function experimentSearchExperimentsProjectsProjectIdExperimentsSearchPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/experiments/search")(
    pathParams,
  );
