 ...
 */
export function promptsSetSelectedGlobalTemplateVersionTemplatesTemplateIdVersionsVersionPut(
...
> {
  ...
  const path = pathToFunc("/templates/{template_id}/versions/{version}")(
    pathParams,
  );
