 ...
 */
export function projectsUpdateUserProjectCollaboratorProjectsProjectIdUsersUserIdPatch(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/users/{user_id}")(pathParams);
