 ...
 */
export function annotationQueueRecordsAddRecordsToAnnotationQueueAnnotationQueuesQueueIdRecordsPost(
  ...
  Result<
    models.AddRecordsToQueueResponse,
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/records")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AddRecordsToQueueResponse$inboundSchema),
