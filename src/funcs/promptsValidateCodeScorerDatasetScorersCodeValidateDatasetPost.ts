 ...
 */
export function promptsValidateCodeScorerDatasetScorersCodeValidateDatasetPost(
  ...
  Result<
    models.ValidateCodeScorerDatasetResponse,
...
> {
  ...
  appendForm(body, "dataset_id", payload.dataset_id);
  ...
  if (payload.dataset_version_index !== undefined) {
    appendForm(body, "dataset_version_index", payload.dataset_version_index);
  }
  ...
  if (payload.score_type !== undefined) {
    appendForm(body, "score_type", payload.score_type);
  }
  ...
  const path = pathToFunc("/scorers/code/validate/dataset")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ValidateCodeScorerDatasetResponse$inboundSchema),
