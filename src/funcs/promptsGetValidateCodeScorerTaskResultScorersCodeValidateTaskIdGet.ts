 ...
 */
export function promptsGetValidateCodeScorerTaskResultScorersCodeValidateTaskIdGet(
  ...
  Result<
    models.RegisteredScorerTaskResultResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RegisteredScorerTaskResultResponse$inboundSchema),
