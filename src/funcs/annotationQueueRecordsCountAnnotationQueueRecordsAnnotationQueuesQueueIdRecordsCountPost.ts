 ...
 */
export function annotationQueueRecordsCountAnnotationQueueRecordsAnnotationQueuesQueueIdRecordsCountPost(
  ...
  Result<
    models.LogRecordsQueryCountResponse,
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/records/count")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogRecordsQueryCountResponse$inboundSchema),
