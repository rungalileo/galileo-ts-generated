 ...
 */
export function annotationQueueRecordsCreateAnnotationQueueRecordRatingAnnotationQueuesQueueIdRecordsRecordIdRatingPut(
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AnnotationRatingDB$inboundSchema),
