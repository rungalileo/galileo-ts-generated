 ...
 */
export function integrationsExportEditsDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogEditsExportPost(
  ...
  Result<
    models.DatabricksUnityCatalogExportEditsResponse,
...
> {
  ...
  const query = encodeFormQuery({
    "ignore_conflicting_edits": payload.ignore_conflicting_edits,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DatabricksUnityCatalogExportEditsResponse$inboundSchema),
