 ...
 */
export function llmIntegrationsGetIntegrationsAndModelInfoLlmIntegrationsGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .GetIntegrationsAndModelInfoLlmIntegrationsGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/llm_integrations")();
