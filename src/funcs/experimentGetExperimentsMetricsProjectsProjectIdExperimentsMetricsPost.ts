 ...
 */
export function experimentGetExperimentsMetricsProjectsProjectIdExperimentsMetricsPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/experiments/metrics")(
    pathParams,
  );
