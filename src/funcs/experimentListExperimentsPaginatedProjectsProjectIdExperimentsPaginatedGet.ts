 ...
 */
export function experimentListExperimentsPaginatedProjectsProjectIdExperimentsPaginatedGet(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/experiments/paginated")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListExperimentResponse$inboundSchema),
