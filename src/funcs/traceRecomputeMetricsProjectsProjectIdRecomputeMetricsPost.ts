 ...
 * Recompute Metrics
 */
export function traceRecomputeMetricsProjectsProjectIdRecomputeMetricsPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/recompute-metrics")(
    pathParams,
  );
