 ...
 */
export function projectsGetProjectsCountProjectsCountPost(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(models.ProjectCollectionParams$outboundSchema), value),
  ...
  const path = pathToFunc("/projects/count")();
