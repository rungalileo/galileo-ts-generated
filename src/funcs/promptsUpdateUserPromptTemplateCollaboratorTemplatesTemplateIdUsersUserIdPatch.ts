 ...
 */
export function promptsUpdateUserPromptTemplateCollaboratorTemplatesTemplateIdUsersUserIdPatch(
...
> {
  ...
  const path = pathToFunc("/templates/{template_id}/users/{user_id}")(
    pathParams,
  );
