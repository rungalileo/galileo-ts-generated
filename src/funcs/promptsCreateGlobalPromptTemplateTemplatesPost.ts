 ...
 */
export function promptsCreateGlobalPromptTemplateTemplatesPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreateGlobalPromptTemplateTemplatesPostRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "create_global_prompt_template_templates_post",
    oAuth2Scopes: [],
