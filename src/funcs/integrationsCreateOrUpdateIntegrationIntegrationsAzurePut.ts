 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsAzurePut(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AzureIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/azure")();
