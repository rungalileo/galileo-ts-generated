 ...
 */
export function datasetsListGroupDatasetCollaboratorsDatasetsDatasetIdGroupsGet(
...
> {
  ...
  const path = pathToFunc("/datasets/{dataset_id}/groups")(pathParams);
