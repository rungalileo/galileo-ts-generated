 ...
 */
export function promptsCreateLlmScorerVersionScorersScorerIdVersionLlmPost(
...
> {
  ...
  const path = pathToFunc("/scorers/{scorer_id}/version/llm")(pathParams);
