 ...
 */
export function datasetsListPromptDatasetsProjectsProjectIdPromptDatasetsGet(
  ...
  Result<
    models.ListPromptDatasetResponse,
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/prompt_datasets")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListPromptDatasetResponse$inboundSchema),
