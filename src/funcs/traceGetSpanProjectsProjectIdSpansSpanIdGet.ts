 ...
 * Get Span
 */
export function traceGetSpanProjectsProjectIdSpansSpanIdGet(
  ...
  Result<
    operations.ResponseGetSpanProjectsProjectIdSpansSpanIdGet,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetSpanProjectsProjectIdSpansSpanIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/spans/{span_id}")(pathParams);

  const query = encodeFormQuery({
    "include_presigned_urls": payload.include_presigned_urls,
  });
  ...
  >(
    M.json(
      200,
      operations.ResponseGetSpanProjectsProjectIdSpansSpanIdGet$inboundSchema,
    ),
