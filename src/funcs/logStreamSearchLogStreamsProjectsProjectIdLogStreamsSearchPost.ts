 ...
 */
export function logStreamSearchLogStreamsProjectsProjectIdLogStreamsSearchPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/log_streams/search")(
    pathParams,
  );
