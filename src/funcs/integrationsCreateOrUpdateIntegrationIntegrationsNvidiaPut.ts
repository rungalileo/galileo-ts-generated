 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsNvidiaPut(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.NvidiaIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/nvidia")();
  ...
  const context = {
    ...
    operationID: "create_or_update_integration_integrations_nvidia_put",
    oAuth2Scopes: [],
