 ...
 */
export function projectsUpdateGroupProjectCollaboratorProjectsProjectIdGroupsGroupIdPatch(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/groups/{group_id}")(
    pathParams,
  );
