 ...
 */
export function datasetsCreateDatasetDatasetsPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.CreateDatasetDatasetsPostRequest$outboundSchema),
        value,
      ),
  ...
  if (payload?.body != null) {
    if (payload?.body.append_suffix_if_duplicate !== undefined) {
      appendForm(
        body,
    ...
    if (payload?.body.copy_from_dataset_id !== undefined) {
      appendForm(
        ...
        payload?.body.copy_from_dataset_id,
      );
    }
    if (payload?.body.copy_from_dataset_version_index !== undefined) {
      appendForm(
        body,
        "copy_from_dataset_version_index",
        payload?.body.copy_from_dataset_version_index,
      );
    }
    if (payload?.body.draft !== undefined) {
      appendForm(body, "draft", payload?.body.draft);
    }
    ...
    if (payload?.body.hidden !== undefined) {
      appendForm(body, "hidden", payload?.body.hidden);
    }
    if (payload?.body.name !== undefined) {
      appendForm(body, "name", payload?.body.name);
    }
    if (payload?.body.project_id !== undefined) {
      appendForm(body, "project_id", payload?.body.project_id);
    }
  }
