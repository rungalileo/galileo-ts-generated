 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsVegasGatewayPut(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.VegasGatewayIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/vegas_gateway")();
  ...
  const context = {
    ...
    operationID: "create_or_update_integration_integrations_vegas_gateway_put",
    oAuth2Scopes: [],
