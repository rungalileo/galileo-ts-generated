 ...
 */
export function traceTracesAvailableColumnsProjectsProjectIdTracesAvailableColumnsPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/traces/available_columns")(
    pathParams,
  );
