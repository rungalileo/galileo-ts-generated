 ...
 * Create Session
 */
export function traceCreateSessionProjectsProjectIdSessionsPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreateSessionProjectsProjectIdSessionsPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/sessions")(pathParams);
  ...
  const context = {
    ...
    operationID: "create_session_projects__project_id__sessions_post",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SessionCreateResponse$inboundSchema),
