 ...
 */
export function annotationQueueQueryAnnotationQueuesAnnotationQueuesQueryPost(
  ...
  Result<
    models.ListAnnotationQueueResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .QueryAnnotationQueuesAnnotationQueuesQueryPostRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/annotation_queues/query")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListAnnotationQueueResponse$inboundSchema),
