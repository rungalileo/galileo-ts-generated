 ...
 */
export function traceMetricsTestingAvailableColumnsProjectsProjectIdMetricsTestingAvailableColumnsPost(
  ...
  Result<
    models.LogRecordsAvailableColumnsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogRecordsAvailableColumnsResponse$inboundSchema),
