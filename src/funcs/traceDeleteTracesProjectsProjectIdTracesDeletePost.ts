 ...
 */
export function traceDeleteTracesProjectsProjectIdTracesDeletePost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .DeleteTracesProjectsProjectIdTracesDeletePostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/traces/delete")(pathParams);
  ...
  const context = {
    ...
    operationID: "delete_traces_projects__project_id__traces_delete_post",
    oAuth2Scopes: [],
