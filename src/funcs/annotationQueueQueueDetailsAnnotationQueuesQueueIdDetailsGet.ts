 ...
 * Queue Details
 */
export function annotationQueueQueueDetailsAnnotationQueuesQueueIdDetailsGet(
  ...
  Result<
    models.AnnotationQueueDetailsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .QueueDetailsAnnotationQueuesQueueIdDetailsGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/details")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AnnotationQueueDetailsResponse$inboundSchema),
