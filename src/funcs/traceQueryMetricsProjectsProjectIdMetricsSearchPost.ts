 ...
 * Query Metrics
 */
export function traceQueryMetricsProjectsProjectIdMetricsSearchPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .QueryMetricsProjectsProjectIdMetricsSearchPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/metrics/search")(pathParams);
  ...
  const context = {
    ...
    operationID: "query_metrics_projects__project_id__metrics_search_post",
    oAuth2Scopes: [],
