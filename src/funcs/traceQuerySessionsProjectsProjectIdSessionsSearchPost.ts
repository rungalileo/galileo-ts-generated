 ...
 * Query Sessions
 */
export function traceQuerySessionsProjectsProjectIdSessionsSearchPost(
  client: GalileoGeneratedCore,
  security: operations.QuerySessionsProjectsProjectIdSessionsSearchPostSecurity,
  request: operations.QuerySessionsProjectsProjectIdSessionsSearchPostRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.LogRecordsQueryResponse,
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/sessions/search")(pathParams);
  ...
  const context = {
    ...
    operationID: "query_sessions_projects__project_id__sessions_search_post",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogRecordsQueryResponse$inboundSchema),
