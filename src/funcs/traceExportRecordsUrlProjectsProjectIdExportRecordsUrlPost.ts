 ...
 * Export Records Url
 */
export function traceExportRecordsUrlProjectsProjectIdExportRecordsUrlPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/export_records/url")(
    pathParams,
  );
