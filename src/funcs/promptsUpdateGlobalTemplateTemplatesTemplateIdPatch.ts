 ...
 */
export function promptsUpdateGlobalTemplateTemplatesTemplateIdPatch(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .UpdateGlobalTemplateTemplatesTemplateIdPatchRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/templates/{template_id}")(pathParams);
  ...
  const context = {
    ...
    operationID: "update_global_template_templates__template_id__patch",
    oAuth2Scopes: [],
