 ...
 */
export function promptsGetGlobalTemplateTemplatesTemplateIdGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetGlobalTemplateTemplatesTemplateIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "get_global_template_templates__template_id__get",
    oAuth2Scopes: [],
