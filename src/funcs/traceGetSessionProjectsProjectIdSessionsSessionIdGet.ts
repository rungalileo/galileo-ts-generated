 ...
 * Get Session
 */
export function traceGetSessionProjectsProjectIdSessionsSessionIdGet(
  client: GalileoGeneratedCore,
  security: operations.GetSessionProjectsProjectIdSessionsSessionIdGetSecurity,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetSessionProjectsProjectIdSessionsSessionIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "get_session_projects__project_id__sessions__session_id__get",
    oAuth2Scopes: [],
