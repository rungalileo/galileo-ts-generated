 ...
 */
export function integrationsCreateOrUpdateNamedCustomIntegrationIntegrationsCustomNamePut(
...
> {
  ...
  const path = pathToFunc("/integrations/custom/{name}")(pathParams);
