 ...
 * Count Spans
 */
export function traceCountSpansProjectsProjectIdSpansCountPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CountSpansProjectsProjectIdSpansCountPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/spans/count")(pathParams);
  ...
  const context = {
    ...
    operationID: "count_spans_projects__project_id__spans_count_post",
    oAuth2Scopes: [],
