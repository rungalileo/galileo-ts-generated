 ...
 */
export function jobsGetJobsForProjectRunProjectsProjectIdRunsRunIdJobsGet(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/runs/{run_id}/jobs")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.JobDB$inboundSchema)),
