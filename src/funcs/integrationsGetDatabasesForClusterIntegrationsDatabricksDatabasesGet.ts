 ...
 */
export function integrationsGetDatabasesForClusterIntegrationsDatabricksDatabasesGet(
...
> {
  ...
  const path = pathToFunc("/integrations/databricks/databases")();
