 ...
 */
export function experimentListExperimentsProjectsProjectIdExperimentsGet(
  ...
  Result<
    Array<models.ExperimentResponse>,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .ListExperimentsProjectsProjectIdExperimentsGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/experiments")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.ExperimentResponse$inboundSchema)),
