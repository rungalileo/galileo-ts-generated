 ...
 * Log Spans
 */
export function traceLogSpansProjectsProjectIdSpansPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.LogSpansProjectsProjectIdSpansPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/spans")(pathParams);
  ...
  const context = {
    ...
    operationID: "log_spans_projects__project_id__spans_post",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogSpansIngestResponse$inboundSchema),
