...
export function promptsBulkDeleteGlobalTemplatesTemplatesBulkDeleteDelete(
  ...
  Result<
    models.BulkDeletePromptTemplatesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.BulkDeletePromptTemplatesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/templates/bulk_delete")();
  ...
  const context = {
    ...
    operationID: "bulk_delete_global_templates_templates_bulk_delete_delete",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BulkDeletePromptTemplatesResponse$inboundSchema),
