 ...
 */
export function datasetsListDatasetProjectsDatasetsDatasetIdProjectsGet(
  client: GalileoGeneratedCore,
  security: operations.ListDatasetProjectsDatasetsDatasetIdProjectsGetSecurity,
  request: operations.ListDatasetProjectsDatasetsDatasetIdProjectsGetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ListDatasetProjectsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .ListDatasetProjectsDatasetsDatasetIdProjectsGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/datasets/{dataset_id}/projects")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListDatasetProjectsResponse$inboundSchema),
