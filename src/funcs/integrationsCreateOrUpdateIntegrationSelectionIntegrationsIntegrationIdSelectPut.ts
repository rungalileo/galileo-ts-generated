 ...
 */
export function integrationsCreateOrUpdateIntegrationSelectionIntegrationsIntegrationIdSelectPut(
...
> {
  ...
  const path = pathToFunc("/integrations/{integration_id}/select")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.IntegrationDB$inboundSchema),
