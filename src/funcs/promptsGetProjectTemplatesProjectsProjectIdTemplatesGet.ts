 ...
 */
export function promptsGetProjectTemplatesProjectsProjectIdTemplatesGet(
  client: GalileoGeneratedCore,
  security: operations.GetProjectTemplatesProjectsProjectIdTemplatesGetSecurity,
  request: operations.GetProjectTemplatesProjectsProjectIdTemplatesGetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.BasePromptTemplateResponse>,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.BasePromptTemplateResponse$inboundSchema)),
