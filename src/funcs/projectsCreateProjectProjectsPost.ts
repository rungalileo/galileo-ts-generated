 ...
 */
export function projectsCreateProjectProjectsPost(
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProjectCreateResponse$inboundSchema),
