 ...
 */
export function integrationsGetIntegrationCostsIntegrationsCostsSummaryGet(
  ...
  Result<
    models.IntegrationCostsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetIntegrationCostsIntegrationsCostsSummaryGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/integrations/costs/summary")();
  ...
  const context = {
    ...
    operationID: "get_integration_costs_integrations_costs_summary_get",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.IntegrationCostsResponse$inboundSchema),
