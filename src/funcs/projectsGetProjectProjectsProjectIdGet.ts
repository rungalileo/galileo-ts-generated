 ...
 * Get Project
 */
export function projectsGetProjectProjectsProjectIdGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetProjectProjectsProjectIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProjectDB$inboundSchema),
