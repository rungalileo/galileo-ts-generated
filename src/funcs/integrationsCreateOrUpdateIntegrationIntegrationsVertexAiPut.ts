 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsVertexAiPut(
  client: GalileoGeneratedCore,
  security: operations.CreateOrUpdateIntegrationIntegrationsVertexAiPutSecurity,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.VertexAIIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/vertex_ai")();
