 ...
 */
export function integrationsGetLabelstudioProjectsIntegrationsLabelstudioProjectsGet(
  ...
  Result<
    Array<models.LabelStudioProject>,
...
> {
  const path = pathToFunc("/integrations/labelstudio/projects")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.LabelStudioProject$inboundSchema)),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
