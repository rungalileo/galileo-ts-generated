 ...
 */
export function codeMetricGenerationGetCodeMetricGenerationStatusCodeMetricGenerationsGenerationIdStatusGet(
  ...
  Result<
    models.CodeMetricGenerationStatusResponse,
...
> {
  ...
  const pathParams = {
    generation_id: encodeSimple("generation_id", payload.generation_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/code-metric-generations/{generation_id}/status")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CodeMetricGenerationStatusResponse$inboundSchema),
