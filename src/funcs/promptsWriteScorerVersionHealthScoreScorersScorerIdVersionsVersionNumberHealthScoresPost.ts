 ...
 */
export function promptsWriteScorerVersionHealthScoreScorersScorerIdVersionsVersionNumberHealthScoresPost(
  ...
  Result<
    models.ScorerVersionHealthScoreEntry,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ScorerVersionHealthScoreEntry$inboundSchema),
