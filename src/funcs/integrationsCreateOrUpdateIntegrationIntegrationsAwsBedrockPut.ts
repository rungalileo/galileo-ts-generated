 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsAwsBedrockPut(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.BaseAwsIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/aws_bedrock")();
