 ...
 */
export function datasetsUpdateGroupDatasetCollaboratorDatasetsDatasetIdGroupsGroupIdPatch(
...
> {
  ...
  const path = pathToFunc("/datasets/{dataset_id}/groups/{group_id}")(
    pathParams,
  );
