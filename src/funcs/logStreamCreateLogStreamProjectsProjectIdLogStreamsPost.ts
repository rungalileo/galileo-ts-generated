 ...
 */
export function logStreamCreateLogStreamProjectsProjectIdLogStreamsPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreateLogStreamProjectsProjectIdLogStreamsPostRequest$outboundSchema,
        value,
      ),
