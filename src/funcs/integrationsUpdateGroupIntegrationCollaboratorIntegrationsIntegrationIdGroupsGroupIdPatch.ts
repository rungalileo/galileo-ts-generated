 ...
 */
export function integrationsUpdateGroupIntegrationCollaboratorIntegrationsIntegrationIdGroupsGroupIdPatch(
...
> {
  ...
  const path = pathToFunc("/integrations/{integration_id}/groups/{group_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GroupCollaborator$inboundSchema),
