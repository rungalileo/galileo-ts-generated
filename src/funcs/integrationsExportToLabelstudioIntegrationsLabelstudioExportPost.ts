 ...
 */
export function integrationsExportToLabelstudioIntegrationsLabelstudioExportPost(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.LabelStudioExportRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/labelstudio/export")();
