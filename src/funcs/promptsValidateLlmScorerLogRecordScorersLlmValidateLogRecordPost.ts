 ...
 */
export function promptsValidateLlmScorerLogRecordScorersLlmValidateLogRecordPost(
  ...
  Result<
    models.ValidateLLMScorerLogRecordResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.ValidateLLMScorerLogRecordRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/scorers/llm/validate/log_record")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ValidateLLMScorerLogRecordResponse$inboundSchema),
