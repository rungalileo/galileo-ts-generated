 ...
 */
export function annotationQueueUpdateAnnotationQueueAnnotationQueuesQueueIdPatch(
  client: GalileoGeneratedCore,
  security:
    operations.UpdateAnnotationQueueAnnotationQueuesQueueIdPatchSecurity,
  request: operations.UpdateAnnotationQueueAnnotationQueuesQueueIdPatchRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.AnnotationQueueResponse,
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AnnotationQueueResponse$inboundSchema),
