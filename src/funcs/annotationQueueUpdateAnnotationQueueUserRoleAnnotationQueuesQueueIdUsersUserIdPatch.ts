 ...
 */
export function annotationQueueUpdateAnnotationQueueUserRoleAnnotationQueuesQueueIdUsersUserIdPatch(
  ...
  Result<
    models.UserAnnotationQueueCollaborator,
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/users/{user_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UserAnnotationQueueCollaborator$inboundSchema),
