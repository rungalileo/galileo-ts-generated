 ...
 */
export function integrationsGetIntegrationStatusIntegrationsNameStatusGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetIntegrationStatusIntegrationsNameStatusGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/integrations/{name}/status")(pathParams);
