 ...
 */
export function traceCountTracesProjectsProjectIdTracesCountPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CountTracesProjectsProjectIdTracesCountPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/traces/count")(pathParams);
  ...
  const context = {
    ...
    operationID: "count_traces_projects__project_id__traces_count_post",
    oAuth2Scopes: [],
