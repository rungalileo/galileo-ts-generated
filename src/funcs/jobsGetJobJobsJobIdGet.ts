 ...
 * Get a job by id.
 */
export function jobsGetJobJobsJobIdGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetJobJobsJobIdGetRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/jobs/{job_id}")(pathParams);
