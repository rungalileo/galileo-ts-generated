 ...
 */
export function traceUpdateSpanProjectsProjectIdSpansSpanIdPatch(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .UpdateSpanProjectsProjectIdSpansSpanIdPatchRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "update_span_projects__project_id__spans__span_id__patch",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogSpanUpdateResponse$inboundSchema),
