 ...
 */
export function integrationsGetNamedCustomIntegrationDefinitionIntegrationsCustomNameDefinitionGet(
  ...
  Result<
    models.CustomIntegrationDefinition,
...
> {
  ...
  const path = pathToFunc("/integrations/custom/{name}/definition")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CustomIntegrationDefinition$inboundSchema),
