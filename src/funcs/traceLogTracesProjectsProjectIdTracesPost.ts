 ...
 * Log Traces
 */
export function traceLogTracesProjectsProjectIdTracesPost(
  ...
  Result<
    models.LogTracesIngestResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.LogTracesProjectsProjectIdTracesPostRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogTracesIngestResponse$inboundSchema),
