 ...
 */
export function projectsDeleteProjectProjectsProjectIdDelete(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteProjectProjectsProjectIdDeleteRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProjectDeleteResponse$inboundSchema),
