 ...
 */
export function datasetsListUserDatasetCollaboratorsDatasetsDatasetIdUsersGet(
...
> {
  ...
  const path = pathToFunc("/datasets/{dataset_id}/users")(pathParams);
