 ...
 */
export function annotationQueueRecordsPartialSearchAnnotationQueueRecordsAnnotationQueuesQueueIdPartialSearchPost(
  ...
  Result<
    models.LogRecordsPartialQueryResponse,
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/partial_search")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogRecordsPartialQueryResponse$inboundSchema),
