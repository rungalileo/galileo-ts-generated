 ...
 */
export function integrationsGetNamedCustomIntegrationIntegrationsCustomNameGet(
  client: GalileoGeneratedCore,
  security:
    operations.GetNamedCustomIntegrationIntegrationsCustomNameGetSecurity,
  request: operations.GetNamedCustomIntegrationIntegrationsCustomNameGetRequest,
