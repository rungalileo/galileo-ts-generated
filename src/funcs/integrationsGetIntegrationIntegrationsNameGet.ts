 ...
 */
export function integrationsGetIntegrationIntegrationsNameGet(
  ...
  Result<
    operations.ResponseGetIntegrationIntegrationsNameGet,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetIntegrationIntegrationsNameGetRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ResponseGetIntegrationIntegrationsNameGet$inboundSchema,
    ),
