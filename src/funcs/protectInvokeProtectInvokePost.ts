 ...
 * Invoke
 */
export function protectInvokeProtectInvokePost(
  ...
  Result<
    operations.ResponseInvokeProtectInvokePost,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.ProtectRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/protect/invoke")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ResponseInvokeProtectInvokePost$inboundSchema),
