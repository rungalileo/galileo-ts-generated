 ...
 */
export function annotationQueueCreateQueueTemplateAnnotationQueuesQueueIdTemplatesPost(
  ...
  Result<
    Array<models.AnnotationTemplateDB>,
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/templates")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.AnnotationTemplateDB$inboundSchema)),
