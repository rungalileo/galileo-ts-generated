 ...
 */
export function integrationsCreateUserIntegrationCollaboratorsIntegrationsIntegrationIdUsersPost(
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.UserCollaborator$inboundSchema)),
