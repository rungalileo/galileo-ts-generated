 ...
 */
export function promptsListScorersWithFiltersScorersListPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ListScorersWithFiltersScorersListPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/scorers/list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListScorersResponse$inboundSchema),
