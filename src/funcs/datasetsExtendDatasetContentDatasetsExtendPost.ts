 ...
 */
export function datasetsExtendDatasetContentDatasetsExtendPost(
  ...
  Result<
    models.SyntheticDatasetExtensionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.SyntheticDatasetExtensionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/datasets/extend")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SyntheticDatasetExtensionResponse$inboundSchema),
