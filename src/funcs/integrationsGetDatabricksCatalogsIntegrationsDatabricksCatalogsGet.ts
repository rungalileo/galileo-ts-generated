 ...
 */
export function integrationsGetDatabricksCatalogsIntegrationsDatabricksCatalogsGet(
...
> {
  const path = pathToFunc("/integrations/databricks/catalogs")();
