 ...
 * Query Datasets
 */
export function datasetsQueryDatasetsDatasetsQueryPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.QueryDatasetsDatasetsQueryPostRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/datasets/query")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListDatasetResponse$inboundSchema),
