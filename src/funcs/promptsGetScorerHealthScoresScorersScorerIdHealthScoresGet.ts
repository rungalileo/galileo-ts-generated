 ...
 */
export function promptsGetScorerHealthScoresScorersScorerIdHealthScoresGet(
  ...
  Result<
    models.ScorerHealthScoresResponse,
...
> {
  ...
  const path = pathToFunc("/scorers/{scorer_id}/health-scores")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ScorerHealthScoresResponse$inboundSchema),
