 ...
 */
export function traceDeleteSpansProjectsProjectIdSpansDeletePost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .DeleteSpansProjectsProjectIdSpansDeletePostRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "delete_spans_projects__project_id__spans_delete_post",
    oAuth2Scopes: [],
