 ...
 * Query Traces
 */
export function traceQueryTracesProjectsProjectIdTracesSearchPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .QueryTracesProjectsProjectIdTracesSearchPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/traces/search")(pathParams);
