 ...
 */
export function llmIntegrationsGetIntegrationsAndModelInfoForRunLlmIntegrationsProjectsProjectIdRunsRunIdGet(
  ...
  Result<
    { [k: string]: models.IntegrationModelsResponse },
...
> {
  ...
  const query = encodeFormQuery({
    "multimodal_capabilities": payload.multimodal_capabilities,
  });
  ...
  >(
    M.json(
      200,
      z.record(z.string(), models.IntegrationModelsResponse$inboundSchema),
    ),
