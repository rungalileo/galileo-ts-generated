 ...
 */
export function experimentTagsDeleteExperimentTagProjectsProjectIdExperimentsExperimentIdTagsTagIdDelete(
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteRunResponse$inboundSchema),
