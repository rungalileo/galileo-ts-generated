 ...
 */
export function promptsSetScorerScopeScorersScorerIdScopePut(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SetScorerScopeScorersScorerIdScopePutRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/scorers/{scorer_id}/scope")(pathParams);
  ...
  const context = {
    ...
    operationID: "set_scorer_scope_scorers__scorer_id__scope_put",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ScorerResponse$inboundSchema),
