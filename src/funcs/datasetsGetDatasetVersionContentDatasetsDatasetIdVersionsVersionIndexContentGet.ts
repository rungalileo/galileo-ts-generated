 ...
 */
export function datasetsGetDatasetVersionContentDatasetsDatasetIdVersionsVersionIndexContentGet(
...
> {
  ...
  const pathParams = {
    ...
    version_index: encodeSimple("version_index", payload.version_index, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DatasetContent$inboundSchema),
