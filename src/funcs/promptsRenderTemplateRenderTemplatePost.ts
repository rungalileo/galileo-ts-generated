 ...
 * Render Template
 */
export function promptsRenderTemplateRenderTemplatePost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.RenderTemplateRenderTemplatePostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/render_template")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RenderTemplateResponse$inboundSchema),
