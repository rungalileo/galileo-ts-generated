 ...
 */
export function integrationsDisableIntegrationIntegrationsDisablePost(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.IntegrationDisableRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/disable")();
  ...
  const context = {
    ...
    operationID: "disable_integration_integrations_disable_post",
    oAuth2Scopes: [],
