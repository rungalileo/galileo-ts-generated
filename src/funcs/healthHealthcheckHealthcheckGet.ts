 ...
 * Healthcheck
 */
export function healthHealthcheckHealthcheckGet(
...
> {
  const path = pathToFunc("/healthcheck")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.HealthcheckResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
