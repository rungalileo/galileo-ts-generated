 ...
 */
export function datasetsUpdateUserDatasetCollaboratorDatasetsDatasetIdUsersUserIdPatch(
...
> {
  ...
  const path = pathToFunc("/datasets/{dataset_id}/users/{user_id}")(pathParams);
