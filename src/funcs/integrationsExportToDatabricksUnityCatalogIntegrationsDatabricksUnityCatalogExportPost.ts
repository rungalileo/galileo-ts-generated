 ...
 */
export function integrationsExportToDatabricksUnityCatalogIntegrationsDatabricksUnityCatalogExportPost(
  ...
  Result<
    models.DatabricksUnityCatalogExportResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.DatabricksExportRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/databricks/unity-catalog/export")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DatabricksUnityCatalogExportResponse$inboundSchema),
