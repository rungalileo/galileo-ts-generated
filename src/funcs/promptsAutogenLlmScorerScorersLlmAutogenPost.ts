 ...
 */
export function promptsAutogenLlmScorerScorersLlmAutogenPost(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.CreateLLMScorerAutogenRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/scorers/llm/autogen")();
  ...
  const context = {
    ...
    operationID: "autogen_llm_scorer_scorers_llm_autogen_post",
    oAuth2Scopes: [],
