 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsMistralPut(
  client: GalileoGeneratedCore,
  security: operations.CreateOrUpdateIntegrationIntegrationsMistralPutSecurity,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.MistralIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/mistral")();
