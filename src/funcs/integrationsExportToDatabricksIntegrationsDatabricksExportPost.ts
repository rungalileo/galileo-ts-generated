 ...
 */
export function integrationsExportToDatabricksIntegrationsDatabricksExportPost(
  ...
  Result<
    models.DatabricksExportResponse,
...
> {
  ...
  const path = pathToFunc("/integrations/databricks/export")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DatabricksExportResponse$inboundSchema),
