 ...
 * Delete Dataset
 */
export function datasetsDeleteDatasetDatasetsDatasetIdDelete(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteDatasetDatasetsDatasetIdDeleteRequest$outboundSchema,
        value,
      ),
