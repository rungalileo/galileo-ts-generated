 ...
 */
export function runScorerSettingsUpsertScorersConfigProjectsProjectIdRunsRunIdScorerSettingsPatch(
  ...
  Result<
    models.RunScorerSettingsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.RunScorerSettingsResponse$inboundSchema),
