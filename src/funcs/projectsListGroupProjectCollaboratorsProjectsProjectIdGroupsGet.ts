 ...
 */
export function projectsListGroupProjectCollaboratorsProjectsProjectIdGroupsGet(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/groups")(pathParams);
