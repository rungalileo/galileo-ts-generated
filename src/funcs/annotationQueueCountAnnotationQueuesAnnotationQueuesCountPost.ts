 ...
 */
export function annotationQueueCountAnnotationQueuesAnnotationQueuesCountPost(
  ...
  Result<
    models.AnnotationQueueCountResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(models.ListAnnotationQueueParams$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/annotation_queues/count")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AnnotationQueueCountResponse$inboundSchema),
