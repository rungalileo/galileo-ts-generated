 ...
 */
export function annotationQueueDeleteAnnotationQueueAnnotationQueuesQueueIdDelete(
  client: GalileoGeneratedCore,
  security:
    operations.DeleteAnnotationQueueAnnotationQueuesQueueIdDeleteSecurity,
  request: operations.DeleteAnnotationQueueAnnotationQueuesQueueIdDeleteRequest,
