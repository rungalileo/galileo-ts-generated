 ...
 */
export function promptsValidateCodeScorerScorersCodeValidatePost(
  ...
  Result<
    models.ValidateCodeScorerResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        models.BodyValidateCodeScorerScorersCodeValidatePost$outboundSchema,
        value,
      ),
  ...
  if (payload.test_input !== undefined) {
    appendForm(body, "test_input", payload.test_input);
  }
  if (payload.test_output !== undefined) {
    appendForm(body, "test_output", payload.test_output);
  }

  const path = pathToFunc("/scorers/code/validate")();
  ...
  const context = {
    ...
    operationID: "validate_code_scorer_scorers_code_validate_post",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ValidateCodeScorerResponse$inboundSchema),
