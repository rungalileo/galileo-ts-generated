 ...
 */
export function datasetsUpsertDatasetContentDatasetsDatasetIdContentPut(
  client: GalileoGeneratedCore,
  security: operations.UpsertDatasetContentDatasetsDatasetIdContentPutSecurity,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .UpsertDatasetContentDatasetsDatasetIdContentPutRequest$outboundSchema,
        value,
      ),
