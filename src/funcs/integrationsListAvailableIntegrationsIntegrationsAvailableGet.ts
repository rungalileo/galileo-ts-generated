 ...
 */
export function integrationsListAvailableIntegrationsIntegrationsAvailableGet(
...
> {
  const path = pathToFunc("/integrations/available")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AvailableIntegrations$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
