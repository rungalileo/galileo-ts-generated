 ...
 */
export function experimentExperimentsAvailableColumnsProjectsProjectIdExperimentsAvailableColumnsPost(
  ...
  Result<
    models.ExperimentsAvailableColumnsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ExperimentsAvailableColumnsResponse$inboundSchema),
