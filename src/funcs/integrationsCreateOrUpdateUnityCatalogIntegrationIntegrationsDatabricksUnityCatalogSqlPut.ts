 ...
 */
export function integrationsCreateOrUpdateUnityCatalogIntegrationIntegrationsDatabricksUnityCatalogSqlPut(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.DatabricksIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/databricks/unity-catalog/sql")();
