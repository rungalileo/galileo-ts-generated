...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateJobRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateJobResponse$inboundSchema),
