 ...
 * Query Partial Spans
 */
export function traceQueryPartialSpansProjectsProjectIdSpansPartialSearchPost(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/spans/partial_search")(
    pathParams,
  );
