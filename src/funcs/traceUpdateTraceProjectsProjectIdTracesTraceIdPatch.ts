 ...
 */
export function traceUpdateTraceProjectsProjectIdTracesTraceIdPatch(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .UpdateTraceProjectsProjectIdTracesTraceIdPatchRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/traces/{trace_id}")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "update_trace_projects__project_id__traces__trace_id__patch",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogTraceUpdateResponse$inboundSchema),
