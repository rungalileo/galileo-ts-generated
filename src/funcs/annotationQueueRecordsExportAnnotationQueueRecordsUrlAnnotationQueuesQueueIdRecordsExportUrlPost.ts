 ...
 */
export function annotationQueueRecordsExportAnnotationQueueRecordsUrlAnnotationQueuesQueueIdRecordsExportUrlPost(
  ...
  Result<
    models.AnnotationQueueExportUrlResponse,
...
> {
  ...
  const path = pathToFunc("/annotation_queues/{queue_id}/records/export/url")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AnnotationQueueExportUrlResponse$inboundSchema),
