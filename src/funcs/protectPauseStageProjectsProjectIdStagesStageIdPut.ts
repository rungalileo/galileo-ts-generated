 ...
 * Pause Stage
 */
export function protectPauseStageProjectsProjectIdStagesStageIdPut(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .PauseStageProjectsProjectIdStagesStageIdPutRequest$outboundSchema,
        value,
      ),
