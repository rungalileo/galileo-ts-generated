 ...
 */
export function promptsCreateGlobalPromptTemplateVersionTemplatesTemplateIdVersionsPost(
  ...
  Result<
    models.BasePromptTemplateVersionResponse,
...
> {
  ...
  const path = pathToFunc("/templates/{template_id}/versions")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.BasePromptTemplateVersionResponse$inboundSchema),
