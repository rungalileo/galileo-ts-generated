 ...
 */
export function annotationQueueGetAnnotationQueueAnnotationQueuesQueueIdGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetAnnotationQueueAnnotationQueuesQueueIdGetRequest$outboundSchema,
        value,
      ),
