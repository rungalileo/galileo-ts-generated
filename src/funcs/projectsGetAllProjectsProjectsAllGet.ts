 ...
 */
export function projectsGetAllProjectsProjectsAllGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.GetAllProjectsProjectsAllGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/projects/all")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.ProjectDBThin$inboundSchema)),
