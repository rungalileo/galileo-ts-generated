 ...
 * Download Dataset
 */
export function datasetsDownloadDatasetDatasetsDatasetIdDownloadGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .DownloadDatasetDatasetsDatasetIdDownloadGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/datasets/{dataset_id}/download")(pathParams);
