 ...
 */
export function promptsGenerateTemplateInputStubInputStubPost(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.TemplateStubRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/input_stub")();
  ...
  const context = {
    ...
    operationID: "generate_template_input_stub_input_stub_post",
    oAuth2Scopes: [],
