 ...
 */
export function integrationsListUserIntegrationCollaboratorsIntegrationsIntegrationIdUsersGet(
  ...
  Result<
    models.ListUserCollaboratorsResponse,
...
> {
  ...
  const path = pathToFunc("/integrations/{integration_id}/users")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListUserCollaboratorsResponse$inboundSchema),
