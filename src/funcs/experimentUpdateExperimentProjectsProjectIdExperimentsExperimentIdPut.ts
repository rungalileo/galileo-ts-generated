 ...
 */
export function experimentUpdateExperimentProjectsProjectIdExperimentsExperimentIdPut(
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/experiments/{experiment_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ExperimentResponse$inboundSchema),
