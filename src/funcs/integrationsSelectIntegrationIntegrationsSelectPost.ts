 ...
 */
export function integrationsSelectIntegrationIntegrationsSelectPost(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.IntegrationSelectRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/select")();
  ...
  const context = {
    ...
    operationID: "select_integration_integrations_select_post",
    oAuth2Scopes: [],
