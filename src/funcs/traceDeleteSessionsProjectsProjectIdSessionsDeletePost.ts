 ...
 */
export function traceDeleteSessionsProjectsProjectIdSessionsDeletePost(
  client: GalileoGeneratedCore,
  security:
    operations.DeleteSessionsProjectsProjectIdSessionsDeletePostSecurity,
  request: operations.DeleteSessionsProjectsProjectIdSessionsDeletePostRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.LogRecordsDeleteResponse,
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/sessions/delete")(pathParams);
  ...
  const context = {
    ...
    operationID: "delete_sessions_projects__project_id__sessions_delete_post",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.LogRecordsDeleteResponse$inboundSchema),
