 ...
 * Query Spans
 */
export function traceQuerySpansProjectsProjectIdSpansSearchPost(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .QuerySpansProjectsProjectIdSpansSearchPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/projects/{project_id}/spans/search")(pathParams);
