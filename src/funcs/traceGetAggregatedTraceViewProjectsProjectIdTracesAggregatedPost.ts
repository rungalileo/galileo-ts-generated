 ...
 */
export function traceGetAggregatedTraceViewProjectsProjectIdTracesAggregatedPost(
  ...
  Result<
    models.AggregatedTraceViewResponse,
...
> {
  ...
  const path = pathToFunc("/projects/{project_id}/traces/aggregated")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AggregatedTraceViewResponse$inboundSchema),
