 ...
 */
export function promptsGetScorerVersionCodeScorersScorerIdVersionCodeGet(
  client: GalileoGeneratedCore,
  security:
    operations.GetScorerVersionCodeScorersScorerIdVersionCodeGetSecurity,
  request: operations.GetScorerVersionCodeScorersScorerIdVersionCodeGetRequest,
