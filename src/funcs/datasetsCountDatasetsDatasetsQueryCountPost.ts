 ...
 */
export function datasetsCountDatasetsDatasetsQueryCountPost(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(models.ListDatasetParams$outboundSchema), value),
  ...
  const path = pathToFunc("/datasets/query/count")();
  ...
  const context = {
    ...
    operationID: "count_datasets_datasets_query_count_post",
    oAuth2Scopes: [],
