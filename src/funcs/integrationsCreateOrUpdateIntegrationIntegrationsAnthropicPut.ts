 ...
 */
export function integrationsCreateOrUpdateIntegrationIntegrationsAnthropicPut(
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AnthropicIntegrationCreate$outboundSchema, value),
  ...
  const path = pathToFunc("/integrations/anthropic")();
