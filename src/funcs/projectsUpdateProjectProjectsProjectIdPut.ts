 ...
 * Update Project
 */
export function projectsUpdateProjectProjectsProjectIdPut(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateProjectProjectsProjectIdPutRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProjectUpdateResponse$inboundSchema),
