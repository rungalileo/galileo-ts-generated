...
import {
  ...
  CompletenessTemplate$inboundSchema,
  CompletenessTemplate$Outbound,
  CompletenessTemplate$outboundSchema,
} from "./completenesstemplate.js";
...
export type CustomizedCompletenessGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedCompletenessGPTScorerClassNameToVocabIx = {
...
export type CustomizedCompletenessGPTScorer = {
  ...
  chainpollTemplate?: CompletenessTemplate | undefined;
...
/** @internal */
export const CustomizedCompletenessGPTScorerFilter$inboundSchema: z.ZodMiniType<
...
/** @internal */
export const CustomizedCompletenessGPTScorerFilter$outboundSchema:
  z.ZodMiniType<
...
export function customizedCompletenessGPTScorerFilterToJSON(
  ...
  return JSON.stringify(
    CustomizedCompletenessGPTScorerFilter$outboundSchema.parse(
      customizedCompletenessGPTScorerFilter,
    ),
  );
}
export function customizedCompletenessGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedCompletenessGPTScorerFilter, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedCompletenessGPTScorerFilter$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedCompletenessGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedCompletenessGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedCompletenessGPTScorerRollUpMethods, unknown> =
    smartUnion([
      z.array(ApiSchemasMetricRollUpNumericRollUpMethod$inboundSchema),
      z.array(CategoricalRollUpMethod$inboundSchema),
    ]);
/** @internal */
export type CustomizedCompletenessGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedCompletenessGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedCompletenessGPTScorerRollUpMethods$Outbound,
...
export function customizedCompletenessGPTScorerRollUpMethodsToJSON(
  customizedCompletenessGPTScorerRollUpMethods:
    CustomizedCompletenessGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedCompletenessGPTScorerRollUpMethods$outboundSchema.parse(
      customizedCompletenessGPTScorerRollUpMethods,
    ),
  );
}
export function customizedCompletenessGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedCompletenessGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedCompletenessGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedCompletenessGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedCompletenessGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<CustomizedCompletenessGPTScorerClassNameToVocabIx, unknown> =
    smartUnion([
      z.record(z.string(), z.array(types.number())),
      z.record(z.string(), types.number()),
    ]);
/** @internal */
export type CustomizedCompletenessGPTScorerClassNameToVocabIx$Outbound = {
  [k: string]: Array<number>;
} | { [k: string]: number };

/** @internal */
export const CustomizedCompletenessGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedCompletenessGPTScorerClassNameToVocabIx$Outbound,
...
export function customizedCompletenessGPTScorerClassNameToVocabIxToJSON(
  customizedCompletenessGPTScorerClassNameToVocabIx:
    CustomizedCompletenessGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedCompletenessGPTScorerClassNameToVocabIx$outboundSchema.parse(
      customizedCompletenessGPTScorerClassNameToVocabIx,
    ),
  );
}
export function customizedCompletenessGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedCompletenessGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedCompletenessGPTScorerClassNameToVocabIx$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedCompletenessGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedCompletenessGPTScorer$inboundSchema: z.ZodMiniType<
  CustomizedCompletenessGPTScorer,
  unknown
> = z.pipe(
  z.object({
    scorer_name: types.literal("_customized_completeness_gpt"),
    model_alias: z._default(types.string(), "gpt-4.1-mini"),
    num_judges: z._default(types.number(), 3),
    name: z._default(types.literal("completeness"), "completeness"),
    ...
    chainpoll_template: types.optional(CompletenessTemplate$inboundSchema),
...
/** @internal */
export type CustomizedCompletenessGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: CompletenessTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedCompletenessGPTScorer$outboundSchema: z.ZodMiniType<
  CustomizedCompletenessGPTScorer$Outbound,
  CustomizedCompletenessGPTScorer
> = z.pipe(
  z.object({
    scorerName: z.literal("_customized_completeness_gpt"),
    modelAlias: z._default(z.string(), "gpt-4.1-mini"),
    numJudges: z._default(z.int(), 3),
    name: z._default(z.literal("completeness"), "completeness" as const),
    scores: z.optional(z.nullable(z.array(z.any()))),
    ...
    chainpollTemplate: z.optional(CompletenessTemplate$outboundSchema),
...
export function customizedCompletenessGPTScorerToJSON(
  customizedCompletenessGPTScorer: CustomizedCompletenessGPTScorer,
): string {
  return JSON.stringify(
    CustomizedCompletenessGPTScorer$outboundSchema.parse(
      customizedCompletenessGPTScorer,
    ),
  );
}
export function customizedCompletenessGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedCompletenessGPTScorer, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomizedCompletenessGPTScorer$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedCompletenessGPTScorer' from JSON`,
  );
}
