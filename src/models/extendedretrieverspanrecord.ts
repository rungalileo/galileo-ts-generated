...
export type ExtendedRetrieverSpanRecordMetricInfo =
  | MetricComputing
  | MetricError
  | MetricFailed
  | MetricNotApplicable
...
/** @internal */
export const ExtendedRetrieverSpanRecordMetricInfo$inboundSchema: z.ZodMiniType<
...
export function extendedRetrieverSpanRecordMetricInfoFromJSON(
  jsonString: string,
): SafeParseResult<ExtendedRetrieverSpanRecordMetricInfo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ExtendedRetrieverSpanRecordMetricInfo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExtendedRetrieverSpanRecordMetricInfo' from JSON`,
  );
}

/** @internal */
export const ExtendedRetrieverSpanRecord$inboundSchema: z.ZodMiniType<
...
export function extendedRetrieverSpanRecordFromJSON(
  jsonString: string,
): SafeParseResult<ExtendedRetrieverSpanRecord, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ExtendedRetrieverSpanRecord$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExtendedRetrieverSpanRecord' from JSON`,
  );
}
