...
export type PartialExtendedRetrieverSpanRecordMetricInfo =
  | MetricComputing
  | MetricError
  | MetricFailed
  | MetricNotApplicable
...
/** @internal */
export const PartialExtendedRetrieverSpanRecordMetricInfo$inboundSchema:
  z.ZodMiniType<PartialExtendedRetrieverSpanRecordMetricInfo, unknown> =
...
export function partialExtendedRetrieverSpanRecordMetricInfoFromJSON(
  jsonString: string,
): SafeParseResult<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      PartialExtendedRetrieverSpanRecordMetricInfo$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'PartialExtendedRetrieverSpanRecordMetricInfo' from JSON`,
  );
}

/** @internal */
export const PartialExtendedRetrieverSpanRecord$inboundSchema: z.ZodMiniType<
...
export function partialExtendedRetrieverSpanRecordFromJSON(
  jsonString: string,
): SafeParseResult<PartialExtendedRetrieverSpanRecord, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      PartialExtendedRetrieverSpanRecord$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PartialExtendedRetrieverSpanRecord' from JSON`,
  );
}
