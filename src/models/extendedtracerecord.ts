...
export function extendedTraceRecordMetricInfoFromJSON(
  jsonString: string,
): SafeParseResult<ExtendedTraceRecordMetricInfo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ExtendedTraceRecordMetricInfo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExtendedTraceRecordMetricInfo' from JSON`,
  );
}

/** @internal */
export const ExtendedTraceRecord$inboundSchema: z.ZodMiniType<
  ExtendedTraceRecord,
  unknown
> = z.pipe(
  z.object({
...
export function extendedTraceRecordFromJSON(
  jsonString: string,
): SafeParseResult<ExtendedTraceRecord, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ExtendedTraceRecord$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExtendedTraceRecord' from JSON`,
  );
}
