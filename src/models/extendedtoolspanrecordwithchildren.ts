...
export type ExtendedToolSpanRecordWithChildrenMetricInfo =
  | MetricComputing
  | MetricError
  | MetricFailed
  | MetricNotApplicable
...
/** @internal */
export const ExtendedToolSpanRecordWithChildrenMetricInfo$inboundSchema:
  z.ZodMiniType<ExtendedToolSpanRecordWithChildrenMetricInfo, unknown> =
...
export function extendedToolSpanRecordWithChildrenMetricInfoFromJSON(
  jsonString: string,
): SafeParseResult<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ExtendedToolSpanRecordWithChildrenMetricInfo$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ExtendedToolSpanRecordWithChildrenMetricInfo' from JSON`,
  );
}

/** @internal */
export const ExtendedToolSpanRecordWithChildren$inboundSchema: z.ZodMiniType<
  ExtendedToolSpanRecordWithChildren,
  unknown
> = z.pipe(
  z.object({
...
export function extendedToolSpanRecordWithChildrenFromJSON(
  jsonString: string,
): SafeParseResult<ExtendedToolSpanRecordWithChildren, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ExtendedToolSpanRecordWithChildren$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExtendedToolSpanRecordWithChildren' from JSON`,
  );
}

/** @internal */
export const ExtendedToolSpanRecordWithChildrenSpan$inboundSchema:
...
export function extendedToolSpanRecordWithChildrenSpanFromJSON(
  jsonString: string,
): SafeParseResult<ExtendedToolSpanRecordWithChildrenSpan, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ExtendedToolSpanRecordWithChildrenSpan$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExtendedToolSpanRecordWithChildrenSpan' from JSON`,
  );
}
