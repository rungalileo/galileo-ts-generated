...
import {
  ...
  AgenticWorkflowSuccessTemplate$inboundSchema,
  AgenticWorkflowSuccessTemplate$Outbound,
  AgenticWorkflowSuccessTemplate$outboundSchema,
} from "./agenticworkflowsuccesstemplate.js";
import {
...
export type CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx = {
...
export type CustomizedAgenticWorkflowSuccessGPTScorer = {
  ...
  name?: "agentic_workflow_success" | undefined;
   ...
   */
  chainpollTemplate?: AgenticWorkflowSuccessTemplate | undefined;
...
/** @internal */
export const CustomizedAgenticWorkflowSuccessGPTScorerFilter$inboundSchema:
...
/** @internal */
export const CustomizedAgenticWorkflowSuccessGPTScorerFilter$outboundSchema:
  z.ZodMiniType<
...
export function customizedAgenticWorkflowSuccessGPTScorerFilterToJSON(
  ...
  return JSON.stringify(
    CustomizedAgenticWorkflowSuccessGPTScorerFilter$outboundSchema.parse(
      customizedAgenticWorkflowSuccessGPTScorerFilter,
    ),
  );
}
export function customizedAgenticWorkflowSuccessGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedAgenticWorkflowSuccessGPTScorerFilter,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedAgenticWorkflowSuccessGPTScorerFilter$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedAgenticWorkflowSuccessGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<
...
/** @internal */
export type CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods$Outbound,
    CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods
  > = smartUnion([
...
export function customizedAgenticWorkflowSuccessGPTScorerRollUpMethodsToJSON(
  customizedAgenticWorkflowSuccessGPTScorerRollUpMethods:
    CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods$outboundSchema.parse(
      customizedAgenticWorkflowSuccessGPTScorerRollUpMethods,
    ),
  );
}
export function customizedAgenticWorkflowSuccessGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'CustomizedAgenticWorkflowSuccessGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<
...
/** @internal */
export type CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx$Outbound =
  | { [k: string]: Array<number> }
  | { [k: string]: number };

/** @internal */
export const CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx$Outbound,
    CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx
  > = smartUnion([
...
export function customizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxToJSON(
  customizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx:
    CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx$outboundSchema
      .parse(customizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx),
  );
}
export function customizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'CustomizedAgenticWorkflowSuccessGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedAgenticWorkflowSuccessGPTScorer$inboundSchema:
  z.ZodMiniType<CustomizedAgenticWorkflowSuccessGPTScorer, unknown> = z.pipe(
    z.object({
      scorer_name: types.literal("_customized_agentic_workflow_success"),
      model_alias: z._default(types.string(), "gpt-4.1"),
      num_judges: z._default(types.number(), 5),
      name: z._default(
        types.literal("agentic_workflow_success"),
...
/** @internal */
export type CustomizedAgenticWorkflowSuccessGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: AgenticWorkflowSuccessTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedAgenticWorkflowSuccessGPTScorer$outboundSchema:
  z.ZodMiniType<
    CustomizedAgenticWorkflowSuccessGPTScorer$Outbound,
    CustomizedAgenticWorkflowSuccessGPTScorer
  > = z.pipe(
    z.object({
      scorerName: z.literal("_customized_agentic_workflow_success"),
      modelAlias: z._default(z.string(), "gpt-4.1"),
      numJudges: z._default(z.int(), 5),
      name: z._default(
        z.literal("agentic_workflow_success"),
        "agentic_workflow_success" as const,
      ),
      scores: z.optional(z.nullable(z.array(z.any()))),
...
export function customizedAgenticWorkflowSuccessGPTScorerToJSON(
  customizedAgenticWorkflowSuccessGPTScorer:
    CustomizedAgenticWorkflowSuccessGPTScorer,
): string {
  return JSON.stringify(
    CustomizedAgenticWorkflowSuccessGPTScorer$outboundSchema.parse(
      customizedAgenticWorkflowSuccessGPTScorer,
    ),
  );
}
export function customizedAgenticWorkflowSuccessGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedAgenticWorkflowSuccessGPTScorer,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedAgenticWorkflowSuccessGPTScorer$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedAgenticWorkflowSuccessGPTScorer' from JSON`,
  );
}
