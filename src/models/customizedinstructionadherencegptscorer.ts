...
import {
  ...
  InstructionAdherenceTemplate$inboundSchema,
  InstructionAdherenceTemplate$Outbound,
  InstructionAdherenceTemplate$outboundSchema,
} from "./instructionadherencetemplate.js";
import {
  LunaInputTypeEnum,
...
export type CustomizedInstructionAdherenceGPTScorerFilter =
  | MetadataFilter
  | NodeNameFilter
  | discriminatedUnionTypes.Unknown<"name">;

export type CustomizedInstructionAdherenceGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx = {
...
export type CustomizedInstructionAdherenceGPTScorer = {
  ...
  name?: "instruction_adherence" | undefined;
  ...
  chainpollTemplate?: InstructionAdherenceTemplate | undefined;
...
/** @internal */
export const CustomizedInstructionAdherenceGPTScorerFilter$inboundSchema:
  z.ZodMiniType<CustomizedInstructionAdherenceGPTScorerFilter, unknown> =
    discriminatedUnion("name", {
      metadata: MetadataFilter$inboundSchema,
      node_name: NodeNameFilter$inboundSchema,
    });
/** @internal */
export type CustomizedInstructionAdherenceGPTScorerFilter$Outbound =
  | MetadataFilter$Outbound
  | NodeNameFilter$Outbound;

/** @internal */
export const CustomizedInstructionAdherenceGPTScorerFilter$outboundSchema:
  z.ZodMiniType<
    CustomizedInstructionAdherenceGPTScorerFilter$Outbound,
    CustomizedInstructionAdherenceGPTScorerFilter
  > = z.union([MetadataFilter$outboundSchema, NodeNameFilter$outboundSchema]);

export function customizedInstructionAdherenceGPTScorerFilterToJSON(
  customizedInstructionAdherenceGPTScorerFilter:
    CustomizedInstructionAdherenceGPTScorerFilter,
): string {
  return JSON.stringify(
    CustomizedInstructionAdherenceGPTScorerFilter$outboundSchema.parse(
      customizedInstructionAdherenceGPTScorerFilter,
    ),
  );
}
export function customizedInstructionAdherenceGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedInstructionAdherenceGPTScorerFilter,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedInstructionAdherenceGPTScorerFilter$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedInstructionAdherenceGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedInstructionAdherenceGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedInstructionAdherenceGPTScorerRollUpMethods, unknown> =
    smartUnion([
      z.array(ApiSchemasMetricRollUpNumericRollUpMethod$inboundSchema),
      z.array(CategoricalRollUpMethod$inboundSchema),
    ]);
/** @internal */
export type CustomizedInstructionAdherenceGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedInstructionAdherenceGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedInstructionAdherenceGPTScorerRollUpMethods$Outbound,
...
export function customizedInstructionAdherenceGPTScorerRollUpMethodsToJSON(
  customizedInstructionAdherenceGPTScorerRollUpMethods:
    CustomizedInstructionAdherenceGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedInstructionAdherenceGPTScorerRollUpMethods$outboundSchema.parse(
      customizedInstructionAdherenceGPTScorerRollUpMethods,
    ),
  );
}
export function customizedInstructionAdherenceGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedInstructionAdherenceGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedInstructionAdherenceGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedInstructionAdherenceGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<
...
/** @internal */
export type CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx$Outbound =
  | { [k: string]: Array<number> }
  | { [k: string]: number };

/** @internal */
export const CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx$Outbound,
    CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx
  > = smartUnion([
...
export function customizedInstructionAdherenceGPTScorerClassNameToVocabIxToJSON(
  customizedInstructionAdherenceGPTScorerClassNameToVocabIx:
    CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx$outboundSchema
      .parse(customizedInstructionAdherenceGPTScorerClassNameToVocabIx),
  );
}
export function customizedInstructionAdherenceGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'CustomizedInstructionAdherenceGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedInstructionAdherenceGPTScorer$inboundSchema:
  z.ZodMiniType<CustomizedInstructionAdherenceGPTScorer, unknown> = z.pipe(
    z.object({
      scorer_name: types.literal("_customized_instruction_adherence"),
      model_alias: z._default(types.string(), "gpt-4.1-mini"),
      num_judges: z._default(types.number(), 3),
      name: z._default(
        types.literal("instruction_adherence"),
...
/** @internal */
export type CustomizedInstructionAdherenceGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: InstructionAdherenceTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedInstructionAdherenceGPTScorer$outboundSchema:
  z.ZodMiniType<
    CustomizedInstructionAdherenceGPTScorer$Outbound,
    CustomizedInstructionAdherenceGPTScorer
  > = z.pipe(
    z.object({
      scorerName: z.literal("_customized_instruction_adherence"),
      modelAlias: z._default(z.string(), "gpt-4.1-mini"),
      numJudges: z._default(z.int(), 3),
      name: z._default(
        z.literal("instruction_adherence"),
        "instruction_adherence" as const,
      ),
      scores: z.optional(z.nullable(z.array(z.any()))),
...
export function customizedInstructionAdherenceGPTScorerToJSON(
  customizedInstructionAdherenceGPTScorer:
    CustomizedInstructionAdherenceGPTScorer,
): string {
  return JSON.stringify(
    CustomizedInstructionAdherenceGPTScorer$outboundSchema.parse(
      customizedInstructionAdherenceGPTScorer,
    ),
  );
}
export function customizedInstructionAdherenceGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedInstructionAdherenceGPTScorer,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedInstructionAdherenceGPTScorer$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedInstructionAdherenceGPTScorer' from JSON`,
  );
}
