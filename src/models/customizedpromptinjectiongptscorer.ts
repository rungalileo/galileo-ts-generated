...
import {
  ...
  PromptInjectionTemplate$inboundSchema,
  PromptInjectionTemplate$Outbound,
  PromptInjectionTemplate$outboundSchema,
} from "./promptinjectiontemplate.js";
import {
  RollUpStrategy,
...
export type CustomizedPromptInjectionGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedPromptInjectionGPTScorerClassNameToVocabIx = {
...
export type CustomizedPromptInjectionGPTScorer = {
  ...
  name?: "prompt_injection" | undefined;
   ...
   */
  chainpollTemplate?: PromptInjectionTemplate | undefined;
...
/** @internal */
export const CustomizedPromptInjectionGPTScorerFilter$inboundSchema:
...
/** @internal */
export const CustomizedPromptInjectionGPTScorerFilter$outboundSchema:
  z.ZodMiniType<
...
export function customizedPromptInjectionGPTScorerFilterToJSON(
  ...
  return JSON.stringify(
    CustomizedPromptInjectionGPTScorerFilter$outboundSchema.parse(
      customizedPromptInjectionGPTScorerFilter,
    ),
  );
}
export function customizedPromptInjectionGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedPromptInjectionGPTScorerFilter,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedPromptInjectionGPTScorerFilter$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedPromptInjectionGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedPromptInjectionGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedPromptInjectionGPTScorerRollUpMethods, unknown> =
    smartUnion([
      z.array(ApiSchemasMetricRollUpNumericRollUpMethod$inboundSchema),
      z.array(CategoricalRollUpMethod$inboundSchema),
    ]);
/** @internal */
export type CustomizedPromptInjectionGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedPromptInjectionGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedPromptInjectionGPTScorerRollUpMethods$Outbound,
...
export function customizedPromptInjectionGPTScorerRollUpMethodsToJSON(
  customizedPromptInjectionGPTScorerRollUpMethods:
    CustomizedPromptInjectionGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedPromptInjectionGPTScorerRollUpMethods$outboundSchema.parse(
      customizedPromptInjectionGPTScorerRollUpMethods,
    ),
  );
}
export function customizedPromptInjectionGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedPromptInjectionGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedPromptInjectionGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedPromptInjectionGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedPromptInjectionGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<CustomizedPromptInjectionGPTScorerClassNameToVocabIx, unknown> =
    smartUnion([
      z.record(z.string(), z.array(types.number())),
      z.record(z.string(), types.number()),
    ]);
/** @internal */
export type CustomizedPromptInjectionGPTScorerClassNameToVocabIx$Outbound = {
  [k: string]: Array<number>;
} | { [k: string]: number };

/** @internal */
export const CustomizedPromptInjectionGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedPromptInjectionGPTScorerClassNameToVocabIx$Outbound,
...
export function customizedPromptInjectionGPTScorerClassNameToVocabIxToJSON(
  customizedPromptInjectionGPTScorerClassNameToVocabIx:
    CustomizedPromptInjectionGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedPromptInjectionGPTScorerClassNameToVocabIx$outboundSchema.parse(
      customizedPromptInjectionGPTScorerClassNameToVocabIx,
    ),
  );
}
export function customizedPromptInjectionGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedPromptInjectionGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedPromptInjectionGPTScorerClassNameToVocabIx$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedPromptInjectionGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedPromptInjectionGPTScorer$inboundSchema: z.ZodMiniType<
  CustomizedPromptInjectionGPTScorer,
  unknown
> = z.pipe(
  z.object({
    scorer_name: types.literal("_customized_prompt_injection_gpt"),
    model_alias: z._default(types.string(), "gpt-4.1-mini"),
    num_judges: z._default(types.number(), 3),
    name: z._default(types.literal("prompt_injection"), "prompt_injection"),
    ...
    chainpoll_template: types.optional(PromptInjectionTemplate$inboundSchema),
...
/** @internal */
export type CustomizedPromptInjectionGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: PromptInjectionTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedPromptInjectionGPTScorer$outboundSchema: z.ZodMiniType<
  CustomizedPromptInjectionGPTScorer$Outbound,
  CustomizedPromptInjectionGPTScorer
> = z.pipe(
  z.object({
    scorerName: z.literal("_customized_prompt_injection_gpt"),
    ...
    chainpollTemplate: z.optional(PromptInjectionTemplate$outboundSchema),
...
export function customizedPromptInjectionGPTScorerToJSON(
  customizedPromptInjectionGPTScorer: CustomizedPromptInjectionGPTScorer,
): string {
  return JSON.stringify(
    CustomizedPromptInjectionGPTScorer$outboundSchema.parse(
      customizedPromptInjectionGPTScorer,
    ),
  );
}
export function customizedPromptInjectionGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedPromptInjectionGPTScorer, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedPromptInjectionGPTScorer$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedPromptInjectionGPTScorer' from JSON`,
  );
}
