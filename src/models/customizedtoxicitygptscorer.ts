...
import {
  ToxicityTemplate,
  ToxicityTemplate$inboundSchema,
  ToxicityTemplate$Outbound,
  ToxicityTemplate$outboundSchema,
} from "./toxicitytemplate.js";
...
export type CustomizedToxicityGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedToxicityGPTScorerClassNameToVocabIx = {
...
export type CustomizedToxicityGPTScorer = {
  ...
  name?: "output_toxicity" | undefined;
   ...
   */
  chainpollTemplate?: ToxicityTemplate | undefined;
...
/** @internal */
export const CustomizedToxicityGPTScorerFilter$inboundSchema: z.ZodMiniType<
...
export function customizedToxicityGPTScorerFilterToJSON(
  ...
  return JSON.stringify(
    CustomizedToxicityGPTScorerFilter$outboundSchema.parse(
      customizedToxicityGPTScorerFilter,
    ),
  );
}
export function customizedToxicityGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedToxicityGPTScorerFilter, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomizedToxicityGPTScorerFilter$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedToxicityGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedToxicityGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedToxicityGPTScorerRollUpMethods, unknown> = smartUnion(
    [
...
/** @internal */
export type CustomizedToxicityGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedToxicityGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedToxicityGPTScorerRollUpMethods$Outbound,
...
export function customizedToxicityGPTScorerRollUpMethodsToJSON(
  customizedToxicityGPTScorerRollUpMethods:
    CustomizedToxicityGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedToxicityGPTScorerRollUpMethods$outboundSchema.parse(
      customizedToxicityGPTScorerRollUpMethods,
    ),
  );
}
export function customizedToxicityGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedToxicityGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedToxicityGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedToxicityGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedToxicityGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<CustomizedToxicityGPTScorerClassNameToVocabIx, unknown> =
    smartUnion([
      z.record(z.string(), z.array(types.number())),
      z.record(z.string(), types.number()),
    ]);
/** @internal */
export type CustomizedToxicityGPTScorerClassNameToVocabIx$Outbound = {
  [k: string]: Array<number>;
} | { [k: string]: number };

/** @internal */
export const CustomizedToxicityGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedToxicityGPTScorerClassNameToVocabIx$Outbound,
...
export function customizedToxicityGPTScorerClassNameToVocabIxToJSON(
  customizedToxicityGPTScorerClassNameToVocabIx:
    CustomizedToxicityGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedToxicityGPTScorerClassNameToVocabIx$outboundSchema.parse(
      customizedToxicityGPTScorerClassNameToVocabIx,
    ),
  );
}
export function customizedToxicityGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedToxicityGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedToxicityGPTScorerClassNameToVocabIx$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedToxicityGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedToxicityGPTScorer$inboundSchema: z.ZodMiniType<
  CustomizedToxicityGPTScorer,
  unknown
> = z.pipe(
  z.object({
    scorer_name: types.literal("_customized_toxicity_gpt"),
    model_alias: z._default(types.string(), "gpt-4.1-mini"),
    num_judges: z._default(types.number(), 3),
    name: z._default(types.literal("output_toxicity"), "output_toxicity"),
    ...
    chainpoll_template: types.optional(ToxicityTemplate$inboundSchema),
...
/** @internal */
export type CustomizedToxicityGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: ToxicityTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedToxicityGPTScorer$outboundSchema: z.ZodMiniType<
  CustomizedToxicityGPTScorer$Outbound,
  CustomizedToxicityGPTScorer
> = z.pipe(
  z.object({
    scorerName: z.literal("_customized_toxicity_gpt"),
    modelAlias: z._default(z.string(), "gpt-4.1-mini"),
    numJudges: z._default(z.int(), 3),
    name: z._default(z.literal("output_toxicity"), "output_toxicity" as const),
    scores: z.optional(z.nullable(z.array(z.any()))),
    ...
    chainpollTemplate: z.optional(ToxicityTemplate$outboundSchema),
...
export function customizedToxicityGPTScorerToJSON(
  customizedToxicityGPTScorer: CustomizedToxicityGPTScorer,
): string {
  return JSON.stringify(
    CustomizedToxicityGPTScorer$outboundSchema.parse(
      customizedToxicityGPTScorer,
    ),
  );
}
export function customizedToxicityGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedToxicityGPTScorer, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomizedToxicityGPTScorer$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedToxicityGPTScorer' from JSON`,
  );
}
