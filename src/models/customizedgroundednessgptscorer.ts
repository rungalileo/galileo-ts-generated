...
import {
  ...
  GroundednessTemplate$inboundSchema,
  GroundednessTemplate$Outbound,
  GroundednessTemplate$outboundSchema,
} from "./groundednesstemplate.js";
import {
  InputTypeEnum,
...
export type CustomizedGroundednessGPTScorerFilter =
  | MetadataFilter
  | NodeNameFilter
  | discriminatedUnionTypes.Unknown<"name">;

export type CustomizedGroundednessGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedGroundednessGPTScorerClassNameToVocabIx = {
...
export type CustomizedGroundednessGPTScorer = {
  ...
  name?: "context_adherence" | undefined;
   ...
   */
  chainpollTemplate?: GroundednessTemplate | undefined;
...
/** @internal */
export const CustomizedGroundednessGPTScorerFilter$inboundSchema: z.ZodMiniType<
...
/** @internal */
export type CustomizedGroundednessGPTScorerFilter$Outbound =
  | MetadataFilter$Outbound
  | NodeNameFilter$Outbound;

/** @internal */
export const CustomizedGroundednessGPTScorerFilter$outboundSchema:
  z.ZodMiniType<
    CustomizedGroundednessGPTScorerFilter$Outbound,
    CustomizedGroundednessGPTScorerFilter
  > = z.union([MetadataFilter$outboundSchema, NodeNameFilter$outboundSchema]);

export function customizedGroundednessGPTScorerFilterToJSON(
  customizedGroundednessGPTScorerFilter: CustomizedGroundednessGPTScorerFilter,
): string {
  return JSON.stringify(
    CustomizedGroundednessGPTScorerFilter$outboundSchema.parse(
      customizedGroundednessGPTScorerFilter,
    ),
  );
}
export function customizedGroundednessGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedGroundednessGPTScorerFilter, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedGroundednessGPTScorerFilter$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedGroundednessGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedGroundednessGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedGroundednessGPTScorerRollUpMethods, unknown> =
    smartUnion([
      z.array(ApiSchemasMetricRollUpNumericRollUpMethod$inboundSchema),
      z.array(CategoricalRollUpMethod$inboundSchema),
    ]);
/** @internal */
export type CustomizedGroundednessGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedGroundednessGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedGroundednessGPTScorerRollUpMethods$Outbound,
...
export function customizedGroundednessGPTScorerRollUpMethodsToJSON(
  customizedGroundednessGPTScorerRollUpMethods:
    CustomizedGroundednessGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedGroundednessGPTScorerRollUpMethods$outboundSchema.parse(
      customizedGroundednessGPTScorerRollUpMethods,
    ),
  );
}
export function customizedGroundednessGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedGroundednessGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedGroundednessGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedGroundednessGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedGroundednessGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<CustomizedGroundednessGPTScorerClassNameToVocabIx, unknown> =
    smartUnion([
      z.record(z.string(), z.array(types.number())),
      z.record(z.string(), types.number()),
    ]);
/** @internal */
export type CustomizedGroundednessGPTScorerClassNameToVocabIx$Outbound = {
  [k: string]: Array<number>;
} | { [k: string]: number };

/** @internal */
export const CustomizedGroundednessGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedGroundednessGPTScorerClassNameToVocabIx$Outbound,
...
export function customizedGroundednessGPTScorerClassNameToVocabIxToJSON(
  customizedGroundednessGPTScorerClassNameToVocabIx:
    CustomizedGroundednessGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedGroundednessGPTScorerClassNameToVocabIx$outboundSchema.parse(
      customizedGroundednessGPTScorerClassNameToVocabIx,
    ),
  );
}
export function customizedGroundednessGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedGroundednessGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedGroundednessGPTScorerClassNameToVocabIx$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedGroundednessGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedGroundednessGPTScorer$inboundSchema: z.ZodMiniType<
  CustomizedGroundednessGPTScorer,
  unknown
> = z.pipe(
  z.object({
    scorer_name: types.literal("_customized_groundedness"),
    model_alias: z._default(types.string(), "gpt-4.1-mini"),
    num_judges: z._default(types.number(), 3),
    name: z._default(types.literal("context_adherence"), "context_adherence"),
    ...
    chainpoll_template: types.optional(GroundednessTemplate$inboundSchema),
...
/** @internal */
export type CustomizedGroundednessGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: GroundednessTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedGroundednessGPTScorer$outboundSchema: z.ZodMiniType<
  CustomizedGroundednessGPTScorer$Outbound,
  CustomizedGroundednessGPTScorer
> = z.pipe(
  z.object({
    scorerName: z.literal("_customized_groundedness"),
    modelAlias: z._default(z.string(), "gpt-4.1-mini"),
    numJudges: z._default(z.int(), 3),
    name: z._default(
      z.literal("context_adherence"),
      "context_adherence" as const,
    ),
    scores: z.optional(z.nullable(z.array(z.any()))),
    ...
    chainpollTemplate: z.optional(GroundednessTemplate$outboundSchema),
...
export function customizedGroundednessGPTScorerToJSON(
  customizedGroundednessGPTScorer: CustomizedGroundednessGPTScorer,
): string {
  return JSON.stringify(
    CustomizedGroundednessGPTScorer$outboundSchema.parse(
      customizedGroundednessGPTScorer,
    ),
  );
}
export function customizedGroundednessGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedGroundednessGPTScorer, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomizedGroundednessGPTScorer$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedGroundednessGPTScorer' from JSON`,
  );
}
