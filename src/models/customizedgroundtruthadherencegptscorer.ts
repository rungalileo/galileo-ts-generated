...
import {
  ...
  GroundTruthAdherenceTemplate$inboundSchema,
  GroundTruthAdherenceTemplate$Outbound,
  GroundTruthAdherenceTemplate$outboundSchema,
} from "./groundtruthadherencetemplate.js";
import {
  InputTypeEnum,
...
export type CustomizedGroundTruthAdherenceGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx = {
...
export type CustomizedGroundTruthAdherenceGPTScorer = {
  ...
  name?: "ground_truth_adherence" | undefined;
  ...
  chainpollTemplate?: GroundTruthAdherenceTemplate | undefined;
...
/** @internal */
export const CustomizedGroundTruthAdherenceGPTScorerFilter$inboundSchema:
...
/** @internal */
export const CustomizedGroundTruthAdherenceGPTScorerFilter$outboundSchema:
  z.ZodMiniType<
...
export function customizedGroundTruthAdherenceGPTScorerFilterToJSON(
  ...
  return JSON.stringify(
    CustomizedGroundTruthAdherenceGPTScorerFilter$outboundSchema.parse(
      customizedGroundTruthAdherenceGPTScorerFilter,
    ),
  );
}
export function customizedGroundTruthAdherenceGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedGroundTruthAdherenceGPTScorerFilter,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedGroundTruthAdherenceGPTScorerFilter$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedGroundTruthAdherenceGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedGroundTruthAdherenceGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedGroundTruthAdherenceGPTScorerRollUpMethods, unknown> =
    smartUnion([
      z.array(ApiSchemasMetricRollUpNumericRollUpMethod$inboundSchema),
      z.array(CategoricalRollUpMethod$inboundSchema),
    ]);
/** @internal */
export type CustomizedGroundTruthAdherenceGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedGroundTruthAdherenceGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedGroundTruthAdherenceGPTScorerRollUpMethods$Outbound,
...
export function customizedGroundTruthAdherenceGPTScorerRollUpMethodsToJSON(
  customizedGroundTruthAdherenceGPTScorerRollUpMethods:
    CustomizedGroundTruthAdherenceGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedGroundTruthAdherenceGPTScorerRollUpMethods$outboundSchema.parse(
      customizedGroundTruthAdherenceGPTScorerRollUpMethods,
    ),
  );
}
export function customizedGroundTruthAdherenceGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedGroundTruthAdherenceGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedGroundTruthAdherenceGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedGroundTruthAdherenceGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<
...
/** @internal */
export type CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx$Outbound =
  | { [k: string]: Array<number> }
  | { [k: string]: number };

/** @internal */
export const CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx$Outbound,
    CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx
  > = smartUnion([
...
export function customizedGroundTruthAdherenceGPTScorerClassNameToVocabIxToJSON(
  customizedGroundTruthAdherenceGPTScorerClassNameToVocabIx:
    CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx$outboundSchema
      .parse(customizedGroundTruthAdherenceGPTScorerClassNameToVocabIx),
  );
}
export function customizedGroundTruthAdherenceGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'CustomizedGroundTruthAdherenceGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedGroundTruthAdherenceGPTScorer$inboundSchema:
  z.ZodMiniType<CustomizedGroundTruthAdherenceGPTScorer, unknown> = z.pipe(
    z.object({
      scorer_name: types.literal("_customized_ground_truth_adherence"),
      model_alias: z._default(types.string(), "gpt-4.1-mini"),
      num_judges: z._default(types.number(), 3),
      name: z._default(
        types.literal("ground_truth_adherence"),
...
/** @internal */
export type CustomizedGroundTruthAdherenceGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: GroundTruthAdherenceTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedGroundTruthAdherenceGPTScorer$outboundSchema:
  z.ZodMiniType<
    CustomizedGroundTruthAdherenceGPTScorer$Outbound,
    CustomizedGroundTruthAdherenceGPTScorer
  > = z.pipe(
    z.object({
      scorerName: z.literal("_customized_ground_truth_adherence"),
      modelAlias: z._default(z.string(), "gpt-4.1-mini"),
      numJudges: z._default(z.int(), 3),
      name: z._default(
        z.literal("ground_truth_adherence"),
        "ground_truth_adherence" as const,
      ),
      scores: z.optional(z.nullable(z.array(z.any()))),
...
export function customizedGroundTruthAdherenceGPTScorerToJSON(
  customizedGroundTruthAdherenceGPTScorer:
    CustomizedGroundTruthAdherenceGPTScorer,
): string {
  return JSON.stringify(
    CustomizedGroundTruthAdherenceGPTScorer$outboundSchema.parse(
      customizedGroundTruthAdherenceGPTScorer,
    ),
  );
}
export function customizedGroundTruthAdherenceGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedGroundTruthAdherenceGPTScorer,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedGroundTruthAdherenceGPTScorer$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedGroundTruthAdherenceGPTScorer' from JSON`,
  );
}
