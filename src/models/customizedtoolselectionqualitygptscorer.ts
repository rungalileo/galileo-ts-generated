...
import {
  ...
  ToolSelectionQualityTemplate$inboundSchema,
  ToolSelectionQualityTemplate$Outbound,
  ToolSelectionQualityTemplate$outboundSchema,
} from "./toolselectionqualitytemplate.js";
...
export type CustomizedToolSelectionQualityGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx = {
...
export type CustomizedToolSelectionQualityGPTScorer = {
  ...
  name?: "tool_selection_quality" | undefined;
   ...
   */
  chainpollTemplate?: ToolSelectionQualityTemplate | undefined;
...
/** @internal */
export const CustomizedToolSelectionQualityGPTScorerFilter$inboundSchema:
...
/** @internal */
export const CustomizedToolSelectionQualityGPTScorerFilter$outboundSchema:
  z.ZodMiniType<
...
export function customizedToolSelectionQualityGPTScorerFilterToJSON(
  ...
  return JSON.stringify(
    CustomizedToolSelectionQualityGPTScorerFilter$outboundSchema.parse(
      customizedToolSelectionQualityGPTScorerFilter,
    ),
  );
}
export function customizedToolSelectionQualityGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedToolSelectionQualityGPTScorerFilter,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedToolSelectionQualityGPTScorerFilter$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedToolSelectionQualityGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedToolSelectionQualityGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedToolSelectionQualityGPTScorerRollUpMethods, unknown> =
    smartUnion([
      z.array(ApiSchemasMetricRollUpNumericRollUpMethod$inboundSchema),
      z.array(CategoricalRollUpMethod$inboundSchema),
    ]);
/** @internal */
export type CustomizedToolSelectionQualityGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedToolSelectionQualityGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedToolSelectionQualityGPTScorerRollUpMethods$Outbound,
...
export function customizedToolSelectionQualityGPTScorerRollUpMethodsToJSON(
  customizedToolSelectionQualityGPTScorerRollUpMethods:
    CustomizedToolSelectionQualityGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedToolSelectionQualityGPTScorerRollUpMethods$outboundSchema.parse(
      customizedToolSelectionQualityGPTScorerRollUpMethods,
    ),
  );
}
export function customizedToolSelectionQualityGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedToolSelectionQualityGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedToolSelectionQualityGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedToolSelectionQualityGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<
...
/** @internal */
export type CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx$Outbound =
  | { [k: string]: Array<number> }
  | { [k: string]: number };

/** @internal */
export const CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx$Outbound,
    CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx
  > = smartUnion([
...
export function customizedToolSelectionQualityGPTScorerClassNameToVocabIxToJSON(
  customizedToolSelectionQualityGPTScorerClassNameToVocabIx:
    CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx$outboundSchema
      .parse(customizedToolSelectionQualityGPTScorerClassNameToVocabIx),
  );
}
export function customizedToolSelectionQualityGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'CustomizedToolSelectionQualityGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedToolSelectionQualityGPTScorer$inboundSchema:
  z.ZodMiniType<CustomizedToolSelectionQualityGPTScorer, unknown> = z.pipe(
    z.object({
      scorer_name: types.literal("_customized_tool_selection_quality"),
      model_alias: z._default(types.string(), "gpt-4.1-mini"),
      num_judges: z._default(types.number(), 3),
      name: z._default(
        types.literal("tool_selection_quality"),
...
/** @internal */
export type CustomizedToolSelectionQualityGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: ToolSelectionQualityTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedToolSelectionQualityGPTScorer$outboundSchema:
  z.ZodMiniType<
    CustomizedToolSelectionQualityGPTScorer$Outbound,
    CustomizedToolSelectionQualityGPTScorer
  > = z.pipe(
    z.object({
      scorerName: z.literal("_customized_tool_selection_quality"),
      modelAlias: z._default(z.string(), "gpt-4.1-mini"),
      numJudges: z._default(z.int(), 3),
      name: z._default(
        z.literal("tool_selection_quality"),
        "tool_selection_quality" as const,
      ),
      scores: z.optional(z.nullable(z.array(z.any()))),
...
export function customizedToolSelectionQualityGPTScorerToJSON(
  customizedToolSelectionQualityGPTScorer:
    CustomizedToolSelectionQualityGPTScorer,
): string {
  return JSON.stringify(
    CustomizedToolSelectionQualityGPTScorer$outboundSchema.parse(
      customizedToolSelectionQualityGPTScorer,
    ),
  );
}
export function customizedToolSelectionQualityGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedToolSelectionQualityGPTScorer,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedToolSelectionQualityGPTScorer$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedToolSelectionQualityGPTScorer' from JSON`,
  );
}
