...
import {
  ...
  InputToxicityTemplate$inboundSchema,
  InputToxicityTemplate$Outbound,
  InputToxicityTemplate$outboundSchema,
} from "./inputtoxicitytemplate.js";
import {
  InputTypeEnum,
...
export type CustomizedInputToxicityGPTScorerFilter =
  | MetadataFilter
  | NodeNameFilter
  | discriminatedUnionTypes.Unknown<"name">;

export type CustomizedInputToxicityGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedInputToxicityGPTScorerClassNameToVocabIx = {
...
export type CustomizedInputToxicityGPTScorer = {
   ...
   */
  chainpollTemplate?: InputToxicityTemplate | undefined;
...
/** @internal */
export const CustomizedInputToxicityGPTScorerFilter$inboundSchema:
  z.ZodMiniType<CustomizedInputToxicityGPTScorerFilter, unknown> =
    discriminatedUnion("name", {
      metadata: MetadataFilter$inboundSchema,
      node_name: NodeNameFilter$inboundSchema,
    });
/** @internal */
export type CustomizedInputToxicityGPTScorerFilter$Outbound =
  | MetadataFilter$Outbound
  | NodeNameFilter$Outbound;

/** @internal */
export const CustomizedInputToxicityGPTScorerFilter$outboundSchema:
  z.ZodMiniType<
    CustomizedInputToxicityGPTScorerFilter$Outbound,
    CustomizedInputToxicityGPTScorerFilter
  > = z.union([MetadataFilter$outboundSchema, NodeNameFilter$outboundSchema]);

export function customizedInputToxicityGPTScorerFilterToJSON(
  customizedInputToxicityGPTScorerFilter:
    CustomizedInputToxicityGPTScorerFilter,
): string {
  return JSON.stringify(
    CustomizedInputToxicityGPTScorerFilter$outboundSchema.parse(
      customizedInputToxicityGPTScorerFilter,
    ),
  );
}
export function customizedInputToxicityGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedInputToxicityGPTScorerFilter, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedInputToxicityGPTScorerFilter$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedInputToxicityGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedInputToxicityGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedInputToxicityGPTScorerRollUpMethods, unknown> =
    smartUnion([
      z.array(ApiSchemasMetricRollUpNumericRollUpMethod$inboundSchema),
      z.array(CategoricalRollUpMethod$inboundSchema),
    ]);
/** @internal */
export type CustomizedInputToxicityGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedInputToxicityGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedInputToxicityGPTScorerRollUpMethods$Outbound,
...
export function customizedInputToxicityGPTScorerRollUpMethodsToJSON(
  customizedInputToxicityGPTScorerRollUpMethods:
    CustomizedInputToxicityGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedInputToxicityGPTScorerRollUpMethods$outboundSchema.parse(
      customizedInputToxicityGPTScorerRollUpMethods,
    ),
  );
}
export function customizedInputToxicityGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedInputToxicityGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedInputToxicityGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedInputToxicityGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedInputToxicityGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<CustomizedInputToxicityGPTScorerClassNameToVocabIx, unknown> =
    smartUnion([
      z.record(z.string(), z.array(types.number())),
      z.record(z.string(), types.number()),
    ]);
/** @internal */
export type CustomizedInputToxicityGPTScorerClassNameToVocabIx$Outbound = {
  [k: string]: Array<number>;
} | { [k: string]: number };

/** @internal */
export const CustomizedInputToxicityGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedInputToxicityGPTScorerClassNameToVocabIx$Outbound,
...
export function customizedInputToxicityGPTScorerClassNameToVocabIxToJSON(
  customizedInputToxicityGPTScorerClassNameToVocabIx:
    CustomizedInputToxicityGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedInputToxicityGPTScorerClassNameToVocabIx$outboundSchema.parse(
      customizedInputToxicityGPTScorerClassNameToVocabIx,
    ),
  );
}
export function customizedInputToxicityGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedInputToxicityGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedInputToxicityGPTScorerClassNameToVocabIx$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedInputToxicityGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedInputToxicityGPTScorer$inboundSchema: z.ZodMiniType<
  CustomizedInputToxicityGPTScorer,
  unknown
> = z.pipe(
  z.object({
    scorer_name: types.literal("_customized_input_toxicity_gpt"),
    model_alias: z._default(types.string(), "gpt-4.1-mini"),
    num_judges: z._default(types.number(), 3),
    name: z._default(types.literal("input_toxicity"), "input_toxicity"),
    ...
    chainpoll_template: types.optional(InputToxicityTemplate$inboundSchema),
...
/** @internal */
export type CustomizedInputToxicityGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: InputToxicityTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedInputToxicityGPTScorer$outboundSchema: z.ZodMiniType<
  CustomizedInputToxicityGPTScorer$Outbound,
  CustomizedInputToxicityGPTScorer
> = z.pipe(
  z.object({
    scorerName: z.literal("_customized_input_toxicity_gpt"),
    modelAlias: z._default(z.string(), "gpt-4.1-mini"),
    numJudges: z._default(z.int(), 3),
    name: z._default(z.literal("input_toxicity"), "input_toxicity" as const),
    scores: z.optional(z.nullable(z.array(z.any()))),
    ...
    chainpollTemplate: z.optional(InputToxicityTemplate$outboundSchema),
...
export function customizedInputToxicityGPTScorerToJSON(
  customizedInputToxicityGPTScorer: CustomizedInputToxicityGPTScorer,
): string {
  return JSON.stringify(
    CustomizedInputToxicityGPTScorer$outboundSchema.parse(
      customizedInputToxicityGPTScorer,
    ),
  );
}
export function customizedInputToxicityGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedInputToxicityGPTScorer, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomizedInputToxicityGPTScorer$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedInputToxicityGPTScorer' from JSON`,
  );
}
