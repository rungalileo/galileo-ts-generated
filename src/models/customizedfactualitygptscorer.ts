...
import {
  FactualityTemplate,
  FactualityTemplate$inboundSchema,
  FactualityTemplate$Outbound,
  FactualityTemplate$outboundSchema,
} from "./factualitytemplate.js";
import {
  InputTypeEnum,
...
export type CustomizedFactualityGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedFactualityGPTScorerClassNameToVocabIx = {
...
export type CustomizedFactualityGPTScorer = {
  ...
  chainpollTemplate?: FactualityTemplate | undefined;
...
/** @internal */
export const CustomizedFactualityGPTScorerFilter$inboundSchema: z.ZodMiniType<
...
export function customizedFactualityGPTScorerFilterToJSON(
  ...
  return JSON.stringify(
    CustomizedFactualityGPTScorerFilter$outboundSchema.parse(
      customizedFactualityGPTScorerFilter,
    ),
  );
}
export function customizedFactualityGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedFactualityGPTScorerFilter, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedFactualityGPTScorerFilter$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedFactualityGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedFactualityGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedFactualityGPTScorerRollUpMethods, unknown> =
    smartUnion([
      z.array(ApiSchemasMetricRollUpNumericRollUpMethod$inboundSchema),
      z.array(CategoricalRollUpMethod$inboundSchema),
    ]);
/** @internal */
export type CustomizedFactualityGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedFactualityGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedFactualityGPTScorerRollUpMethods$Outbound,
...
export function customizedFactualityGPTScorerRollUpMethodsToJSON(
  customizedFactualityGPTScorerRollUpMethods:
    CustomizedFactualityGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedFactualityGPTScorerRollUpMethods$outboundSchema.parse(
      customizedFactualityGPTScorerRollUpMethods,
    ),
  );
}
export function customizedFactualityGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedFactualityGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedFactualityGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedFactualityGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedFactualityGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<CustomizedFactualityGPTScorerClassNameToVocabIx, unknown> =
    smartUnion([
      z.record(z.string(), z.array(types.number())),
      z.record(z.string(), types.number()),
    ]);
/** @internal */
export type CustomizedFactualityGPTScorerClassNameToVocabIx$Outbound = {
  [k: string]: Array<number>;
} | { [k: string]: number };

/** @internal */
export const CustomizedFactualityGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedFactualityGPTScorerClassNameToVocabIx$Outbound,
...
export function customizedFactualityGPTScorerClassNameToVocabIxToJSON(
  customizedFactualityGPTScorerClassNameToVocabIx:
    CustomizedFactualityGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedFactualityGPTScorerClassNameToVocabIx$outboundSchema.parse(
      customizedFactualityGPTScorerClassNameToVocabIx,
    ),
  );
}
export function customizedFactualityGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedFactualityGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedFactualityGPTScorerClassNameToVocabIx$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedFactualityGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedFactualityGPTScorer$inboundSchema: z.ZodMiniType<
  CustomizedFactualityGPTScorer,
  unknown
> = z.pipe(
  z.object({
    scorer_name: types.literal("_customized_factuality"),
    model_alias: z._default(types.string(), "gpt-4.1-mini"),
    num_judges: z._default(types.number(), 3),
    name: z._default(types.literal("correctness"), "correctness"),
    ...
    chainpoll_template: types.optional(FactualityTemplate$inboundSchema),
...
/** @internal */
export type CustomizedFactualityGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: FactualityTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedFactualityGPTScorer$outboundSchema: z.ZodMiniType<
  CustomizedFactualityGPTScorer$Outbound,
  CustomizedFactualityGPTScorer
> = z.pipe(
  z.object({
    scorerName: z.literal("_customized_factuality"),
    modelAlias: z._default(z.string(), "gpt-4.1-mini"),
    numJudges: z._default(z.int(), 3),
    name: z._default(z.literal("correctness"), "correctness" as const),
    scores: z.optional(z.nullable(z.array(z.any()))),
    ...
    chainpollTemplate: z.optional(FactualityTemplate$outboundSchema),
...
export function customizedFactualityGPTScorerToJSON(
  customizedFactualityGPTScorer: CustomizedFactualityGPTScorer,
): string {
  return JSON.stringify(
    CustomizedFactualityGPTScorer$outboundSchema.parse(
      customizedFactualityGPTScorer,
    ),
  );
}
export function customizedFactualityGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedFactualityGPTScorer, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomizedFactualityGPTScorer$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedFactualityGPTScorer' from JSON`,
  );
}
