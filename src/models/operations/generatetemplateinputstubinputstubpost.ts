...
export type GenerateTemplateInputStubInputStubPostSecurity = {
...
/** @internal */
export type GenerateTemplateInputStubInputStubPostSecurity$Outbound = {
  ClassicAPIKeyHeader?: string | undefined;
  APIKeyHeader?: string | undefined;
...
/** @internal */
export const GenerateTemplateInputStubInputStubPostSecurity$outboundSchema:
  z.ZodMiniType<
    GenerateTemplateInputStubInputStubPostSecurity$Outbound,
...
export function generateTemplateInputStubInputStubPostSecurityToJSON(
  generateTemplateInputStubInputStubPostSecurity:
    GenerateTemplateInputStubInputStubPostSecurity,
): string {
  return JSON.stringify(
    GenerateTemplateInputStubInputStubPostSecurity$outboundSchema.parse(
      generateTemplateInputStubInputStubPostSecurity,
    ),
  );
}
