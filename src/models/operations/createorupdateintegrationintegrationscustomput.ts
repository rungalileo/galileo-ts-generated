...
export type CreateOrUpdateIntegrationIntegrationsCustomPutSecurity = {
...
/** @internal */
export type CreateOrUpdateIntegrationIntegrationsCustomPutSecurity$Outbound = {
  ClassicAPIKeyHeader?: string | undefined;
  APIKeyHeader?: string | undefined;
...
/** @internal */
export const CreateOrUpdateIntegrationIntegrationsCustomPutSecurity$outboundSchema:
  z.ZodMiniType<
    CreateOrUpdateIntegrationIntegrationsCustomPutSecurity$Outbound,
...
export function createOrUpdateIntegrationIntegrationsCustomPutSecurityToJSON(
  createOrUpdateIntegrationIntegrationsCustomPutSecurity:
    CreateOrUpdateIntegrationIntegrationsCustomPutSecurity,
): string {
  return JSON.stringify(
    CreateOrUpdateIntegrationIntegrationsCustomPutSecurity$outboundSchema.parse(
      createOrUpdateIntegrationIntegrationsCustomPutSecurity,
    ),
  );
}
