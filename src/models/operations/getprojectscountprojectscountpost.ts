...
export type GetProjectsCountProjectsCountPostSecurity = {
...
/** @internal */
export type GetProjectsCountProjectsCountPostSecurity$Outbound = {
  APIKeyHeader?: string | undefined;
  ClassicAPIKeyHeader?: string | undefined;
...
/** @internal */
export const GetProjectsCountProjectsCountPostSecurity$outboundSchema:
  z.ZodMiniType<
    GetProjectsCountProjectsCountPostSecurity$Outbound,
...
export function getProjectsCountProjectsCountPostSecurityToJSON(
  getProjectsCountProjectsCountPostSecurity:
    GetProjectsCountProjectsCountPostSecurity,
): string {
  return JSON.stringify(
    GetProjectsCountProjectsCountPostSecurity$outboundSchema.parse(
      getProjectsCountProjectsCountPostSecurity,
    ),
  );
}
