...
import {
  ...
  ToolErrorRateTemplate$inboundSchema,
  ToolErrorRateTemplate$Outbound,
  ToolErrorRateTemplate$outboundSchema,
} from "./toolerrorratetemplate.js";

export type CustomizedToolErrorRateGPTScorerFilter =
  | MetadataFilter
  | NodeNameFilter
  | discriminatedUnionTypes.Unknown<"name">;

export type CustomizedToolErrorRateGPTScorerRollUpMethods =
  | Array<ApiSchemasMetricRollUpNumericRollUpMethod>
  | Array<CategoricalRollUpMethod>;

export type CustomizedToolErrorRateGPTScorerClassNameToVocabIx = {
...
export type CustomizedToolErrorRateGPTScorer = {
  ...
  name?: "tool_error_rate" | undefined;
   ...
   */
  chainpollTemplate?: ToolErrorRateTemplate | undefined;
...
/** @internal */
export const CustomizedToolErrorRateGPTScorerFilter$inboundSchema:
  z.ZodMiniType<CustomizedToolErrorRateGPTScorerFilter, unknown> =
    discriminatedUnion("name", {
      metadata: MetadataFilter$inboundSchema,
      node_name: NodeNameFilter$inboundSchema,
    });
/** @internal */
export type CustomizedToolErrorRateGPTScorerFilter$Outbound =
  | MetadataFilter$Outbound
  | NodeNameFilter$Outbound;

/** @internal */
export const CustomizedToolErrorRateGPTScorerFilter$outboundSchema:
  z.ZodMiniType<
    CustomizedToolErrorRateGPTScorerFilter$Outbound,
    CustomizedToolErrorRateGPTScorerFilter
  > = z.union([MetadataFilter$outboundSchema, NodeNameFilter$outboundSchema]);

export function customizedToolErrorRateGPTScorerFilterToJSON(
  customizedToolErrorRateGPTScorerFilter:
    CustomizedToolErrorRateGPTScorerFilter,
): string {
  return JSON.stringify(
    CustomizedToolErrorRateGPTScorerFilter$outboundSchema.parse(
      customizedToolErrorRateGPTScorerFilter,
    ),
  );
}
export function customizedToolErrorRateGPTScorerFilterFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedToolErrorRateGPTScorerFilter, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedToolErrorRateGPTScorerFilter$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedToolErrorRateGPTScorerFilter' from JSON`,
  );
}

/** @internal */
export const CustomizedToolErrorRateGPTScorerRollUpMethods$inboundSchema:
  z.ZodMiniType<CustomizedToolErrorRateGPTScorerRollUpMethods, unknown> =
    smartUnion([
      z.array(ApiSchemasMetricRollUpNumericRollUpMethod$inboundSchema),
      z.array(CategoricalRollUpMethod$inboundSchema),
    ]);
/** @internal */
export type CustomizedToolErrorRateGPTScorerRollUpMethods$Outbound =
  | Array<string>
  | Array<string>;

/** @internal */
export const CustomizedToolErrorRateGPTScorerRollUpMethods$outboundSchema:
  z.ZodMiniType<
    CustomizedToolErrorRateGPTScorerRollUpMethods$Outbound,
...
export function customizedToolErrorRateGPTScorerRollUpMethodsToJSON(
  customizedToolErrorRateGPTScorerRollUpMethods:
    CustomizedToolErrorRateGPTScorerRollUpMethods,
): string {
  return JSON.stringify(
    CustomizedToolErrorRateGPTScorerRollUpMethods$outboundSchema.parse(
      customizedToolErrorRateGPTScorerRollUpMethods,
    ),
  );
}
export function customizedToolErrorRateGPTScorerRollUpMethodsFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedToolErrorRateGPTScorerRollUpMethods,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedToolErrorRateGPTScorerRollUpMethods$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedToolErrorRateGPTScorerRollUpMethods' from JSON`,
  );
}

/** @internal */
export const CustomizedToolErrorRateGPTScorerClassNameToVocabIx$inboundSchema:
  z.ZodMiniType<CustomizedToolErrorRateGPTScorerClassNameToVocabIx, unknown> =
    smartUnion([
      z.record(z.string(), z.array(types.number())),
      z.record(z.string(), types.number()),
    ]);
/** @internal */
export type CustomizedToolErrorRateGPTScorerClassNameToVocabIx$Outbound = {
  [k: string]: Array<number>;
} | { [k: string]: number };

/** @internal */
export const CustomizedToolErrorRateGPTScorerClassNameToVocabIx$outboundSchema:
  z.ZodMiniType<
    CustomizedToolErrorRateGPTScorerClassNameToVocabIx$Outbound,
...
export function customizedToolErrorRateGPTScorerClassNameToVocabIxToJSON(
  customizedToolErrorRateGPTScorerClassNameToVocabIx:
    CustomizedToolErrorRateGPTScorerClassNameToVocabIx,
): string {
  return JSON.stringify(
    CustomizedToolErrorRateGPTScorerClassNameToVocabIx$outboundSchema.parse(
      customizedToolErrorRateGPTScorerClassNameToVocabIx,
    ),
  );
}
export function customizedToolErrorRateGPTScorerClassNameToVocabIxFromJSON(
  jsonString: string,
): SafeParseResult<
  CustomizedToolErrorRateGPTScorerClassNameToVocabIx,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CustomizedToolErrorRateGPTScorerClassNameToVocabIx$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CustomizedToolErrorRateGPTScorerClassNameToVocabIx' from JSON`,
  );
}

/** @internal */
export const CustomizedToolErrorRateGPTScorer$inboundSchema: z.ZodMiniType<
  CustomizedToolErrorRateGPTScorer,
  unknown
> = z.pipe(
  z.object({
    scorer_name: types.literal("_customized_tool_error_rate"),
    model_alias: z._default(types.string(), "gpt-4.1-mini"),
    num_judges: z._default(types.number(), 1),
    name: z._default(types.literal("tool_error_rate"), "tool_error_rate"),
    ...
    chainpoll_template: types.optional(ToolErrorRateTemplate$inboundSchema),
...
/** @internal */
export type CustomizedToolErrorRateGPTScorer$Outbound = {
  ...
  description?: string | null | undefined;
  chainpoll_template?: ToolErrorRateTemplate$Outbound | undefined;
...
/** @internal */
export const CustomizedToolErrorRateGPTScorer$outboundSchema: z.ZodMiniType<
  CustomizedToolErrorRateGPTScorer$Outbound,
  CustomizedToolErrorRateGPTScorer
> = z.pipe(
  z.object({
    scorerName: z.literal("_customized_tool_error_rate"),
    modelAlias: z._default(z.string(), "gpt-4.1-mini"),
    numJudges: z._default(z.int(), 1),
    name: z._default(z.literal("tool_error_rate"), "tool_error_rate" as const),
    scores: z.optional(z.nullable(z.array(z.any()))),
    ...
    chainpollTemplate: z.optional(ToolErrorRateTemplate$outboundSchema),
...
export function customizedToolErrorRateGPTScorerToJSON(
  customizedToolErrorRateGPTScorer: CustomizedToolErrorRateGPTScorer,
): string {
  return JSON.stringify(
    CustomizedToolErrorRateGPTScorer$outboundSchema.parse(
      customizedToolErrorRateGPTScorer,
    ),
  );
}
export function customizedToolErrorRateGPTScorerFromJSON(
  jsonString: string,
): SafeParseResult<CustomizedToolErrorRateGPTScorer, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CustomizedToolErrorRateGPTScorer$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CustomizedToolErrorRateGPTScorer' from JSON`,
  );
}
