  ...
  const option = options.find((opts) => {
    return opts.every((o) => {
      if (o.value == null) {
        ...
        return (
          (typeof o.value === "string" && !!o.value) || isPlainObject(o.value)
        );
...
export function resolveOAuth2Password(
  ...
  if (
    isPlainObject(value)
    || (defaults.username && defaults.password && defaults.tokenURL)
  ) {
